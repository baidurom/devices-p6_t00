...
.field private static final DEFAULT_WIFI_AP_CHANNEL:I = 0x6
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I
    ...
    iput-boolean v6, v0, Lcom/android/server/NativeDaemonConnector;->on:Z
...
.method static synthetic access$1000(Lcom/android/server/NetworkManagementService;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1, p2}, Lcom/android/server/NetworkManagementService;->notifyApLinkedStaListChange(Ljava/lang/String;Ljava/lang/String;)V
...
.method private getApLinkedDhcpList()Ljava/util/List;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1722
    :try_start_0
    const-string v9, "softap getdhcplease"
    ...
    const-string v11, "getApLinkedDhcpList:"
    ...
    invoke-virtual {v9, v1, v10}, Lcom/android/server/NativeDaemonConnector;->doListCommand(Ljava/lang/String;I)[Ljava/lang/String;

    move-result-object v3

    .line 1726
    .local v3, dhcpleaseList:[Ljava/lang/String;
    if-nez v3, :cond_0

    .line 1727
    const-string v9, "NetworkManagementService"

    const-string v10, "getApLinkedDhcpList Error: doListCommand return NULL"
    ...
    .end local v3           #dhcpleaseList:[Ljava/lang/String;
    :goto_0
    return-object v7

    .line 1731
    .restart local v1       #cmdStr:Ljava/lang/String;
    .restart local v3       #dhcpleaseList:[Ljava/lang/String;
    :cond_0
    ...
    .line 1732
    .local v7, mDhcpList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    move-object v0, v3
    ...
    .line 1733
    .local v2, dhcplease:Ljava/lang/String;
    const-string v9, "NetworkManagementService"
    ...
    const-string v11, "getApLinkedDhcpList dhcpList = "
    ...
    .line 1736
    .end local v2           #dhcplease:Ljava/lang/String;
    :cond_1
    const-string v9, "NetworkManagementService"
    ...
    const-string v11, "getApLinkedDhcpList: mDhcpList size="
    ...
    .end local v5           #i$:I
    .end local v6           #len$:I
    .end local v7           #mDhcpList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :catch_0
    move-exception v4
    ...
    const-string v10, "Cannot communicate with native daemon to get dhcp lease information"
...
.method private getApLinkedStaInfo(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    .locals 11
    .parameter "mac"
    .parameter
    .annotation system Ldalvik/annotation/Signature;
    ...
    .prologue
    .local p2, mDhcpList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    const/4 v10, 0x3
    ...
    .line 1746
    .local v0, ApLinkedStaInfo:Ljava/lang/String;
    ...
    const-string v6, "getApLinkedStaInfo: dhcplease token = "
...
.method private notifyApLinkedStaListChange(Ljava/lang/String;Ljava/lang/String;)V
    .locals 12
    .parameter "event"
    .parameter "macStr"
    ...
    .line 1653
    const-string v0, "android.net.wifi.WIFI_AP_STA_JOIN"

    .line 1654
    iget v8, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I

    add-int/lit8 v8, v8, 0x1

    iput v8, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I
    ...
    const-string v10, "mLinkedStaCount over flow, need synchronize. value = "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v10, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I
    ...
    .line 1664
    :try_start_0
    const-string v8, "softap assoclist"
    ...
    invoke-virtual {v8, v2, v9}, Lcom/android/server/NativeDaemonConnector;->doListCommand(Ljava/lang/String;I)[Ljava/lang/String;
    ...
    .end local v6           #macList:[Ljava/lang/String;
    :cond_2
    :goto_1
    const-string v8, "MAC=%s TIME=%d STACNT=%d"
    ...
    iget v11, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I
    ...
    .line 1680
    .local v7, staInfo:Ljava/lang/String;
    const-string v8, "NetworkManagementService"
    ...
    const-string v10, "send broadcast, event="
    ...
    const-string v8, "macInfo"

    invoke-virtual {v1, v8, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 1685
    const-string v8, "staCount"

    iget v9, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I
    ...
    .end local v7           #staInfo:Ljava/lang/String;
    :cond_3
    ...
    .line 1656
    const-string v0, "android.net.wifi.WIFI_AP_STA_LEAVE"
    ...
    .restart local v6       #macList:[Ljava/lang/String;
    :cond_4
    :try_start_1
    array-length v8, v6
    ...
    const-string v9, "Cannot communicate with native daemon to get linked stations list"

    invoke-static {v8, v9}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1674
    iput v11, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I
...
.method public getApLinkedStaList()Ljava/util/List;
    ...
    .line 1691
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/NetworkManagementService;->getApLinkedDhcpList()Ljava/util/List;

    move-result-object v6

    .line 1693
    .local v6, mDhcpList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    const-string v9, "softap assoclist"
    ...
    const-string v11, "getApLinkedStaList: "
    ...
    const-string v10, "getApLinkedStaList Error: doListCommand return NULL"
    ...
    iput v9, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I
    ...
    invoke-direct {p0, v7, v6}, Lcom/android/server/NetworkManagementService;->getApLinkedStaInfo(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    const-string v11, "getApLinkedStaList ApLinkedStaInfo = "
    ...
    const-string v11, "getApLinkedStaList, info size="
    ...
    .end local v1           #cmdStr:Ljava/lang/String;
    .end local v3           #i$:I
    .end local v4           #infoList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .end local v5           #len$:I
    .end local v6           #mDhcpList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    ...
    const-string v10, "Cannot communicate with native daemon to get linked stations list"
...
.method public setAccessPointHw(Landroid/net/wifi/HuaweiApConfiguration;Ljava/lang/String;Ljava/lang/String;)V
    .locals 6
    .parameter "hwApConfig"
    .parameter "wlanIface"
    ...
    iget v5, p1, Landroid/net/wifi/HuaweiApConfiguration;->channel:I
    ...
    iget v5, p1, Landroid/net/wifi/HuaweiApConfiguration;->maxScb:I
    ...
    const-string v4, "setAccessPointHw command: "
...
.method public setSoftapDisassociateSta(Ljava/lang/String;)V
    ...
    const-string v3, "softap disassociatesta "
    ...
    const-string v3, "Cannot communicate with native daemon to disassociate a station"
...
.method public setSoftapMacFilter(Ljava/lang/String;)V
    ...
    const-string v3, "softap setmacfilter "
    ...
    const-string v4, "setSoftapMacFilter:"
    ...
    const-string v3, "Cannot communicate with native daemon to set MAC Filter"
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    iput v3, p0, Lcom/android/server/NetworkManagementService;->mLinkedStaCount:I
    ...
    const-string v4, "wifi_ap_channel"
    ...
    const-string v4, "wifi_ap_maxscb"
    ...
    const-string v5, "startAccessPoint set AP("
