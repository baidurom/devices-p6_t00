...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #getter for: Lcom/android/server/ConnectivityService;->wifiDisconnectManager:Lcom/android/server/ConnectivityService$WifiDisconnectManager;
    invoke-static {v3}, Lcom/android/server/ConnectivityService;->access$1300(Lcom/android/server/ConnectivityService;)Lcom/android/server/ConnectivityService$WifiDisconnectManager;

    move-result-object v3

    #calls: Lcom/android/server/ConnectivityService$WifiDisconnectManager;->handleConnecting(Landroid/net/NetworkInfo;Landroid/net/NetworkInfo$State;)V
    invoke-static {v3, v0, v1}, Lcom/android/server/ConnectivityService$WifiDisconnectManager;->access$1400(Lcom/android/server/ConnectivityService$WifiDisconnectManager;Landroid/net/NetworkInfo;Landroid/net/NetworkInfo$State;)V
    ...
    invoke-static {v3}, Lcom/android/server/ConnectivityService;->access$1900(Lcom/android/server/ConnectivityService;)Lcom/android/server/net/LockdownVpnTracker;
    ...
    invoke-static {v3, v0}, Lcom/android/server/ConnectivityService;->access$1800(Lcom/android/server/ConnectivityService;Landroid/net/NetworkInfo;)V
    ...
    invoke-static {v3, v4, v5}, Lcom/android/server/ConnectivityService;->access$2000(Lcom/android/server/ConnectivityService;IZ)V
