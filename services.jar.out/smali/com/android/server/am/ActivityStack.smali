...
.field private static final mExtraPersistentActivities:[Ljava/lang/String;

.field static final mIsHwNaviBar:Z

.field static final mProfile:Lcom/android/server/am/AppDvfsAdapter;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/ActivityStack;->mIsHwNaviBar:Z

    .line 299
    new-instance v0, Lcom/android/server/am/AppDvfsAdapter;

    invoke-direct {v0}, Lcom/android/server/am/AppDvfsAdapter;-><init>()V

    sput-object v0, Lcom/android/server/am/ActivityStack;->mProfile:Lcom/android/server/am/AppDvfsAdapter;
    ...
    sput-object v0, Lcom/android/server/am/ActivityStack;->mExtraPersistentActivities:[Ljava/lang/String;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    .line 450
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mPower:Landroid/os/PowerManager;
...
.method private final completePauseLocked()V
    ...
    iput-object v6, p0, Lcom/android/server/am/ActivityStack;->mRuningBackground:Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, v3, v9, v7, v6}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
...
.method private final startPausingLocked(ZZ)V
    ...
    iget-object v4, v3, Lcom/android/server/am/ActivityRecord;->thumbHolder:Lcom/android/server/am/ThumbnailHolder;
...
# virtual methods
.method public SendIntentToPmqos(Landroid/content/Context;Ljava/lang/String;)V
    .locals 4
    .parameter "context"
    .parameter "state"
    ...
    const-string v2, "android.server.am.ActivityStack.statechange"
...
.method public SendToPermission(Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
    .parameter "context"
    .parameter "pkgName"
    ...
    const-string v1, "android.server.am.ActivityStack.taskstatechange"
...
.method final activityPaused(Landroid/os/IBinder;Z)V
    ...
    .line 1098
    sget-object v3, Lcom/android/server/am/ActivityStack;->mProfile:Lcom/android/server/am/AppDvfsAdapter;
    ...
    invoke-virtual {v3, v5, v4, v5}, Lcom/android/server/am/AppDvfsAdapter;->setProfile(III)V
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/server/am/AppDvfsAdapter;->closeProfile(J)V
...
.method final ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    iget-object v2, v7, Lcom/android/server/am/ActivityManagerService;->mConfiguration:Landroid/content/res/Configuration;
    ...
    iget-object v7, v7, Lcom/android/server/am/ActivityManagerService;->mCurConfiguration:Landroid/content/res/Configuration;

    if-eqz v7, :cond_4

    sget-boolean v7, Lcom/android/server/am/ActivityStack;->mIsHwNaviBar:Z
    ...
    .line 4811
    .local v1, newChanges:I
    and-int/lit16 v7, v1, 0x500
    ...
    invoke-virtual {p0, p1, v5, v6, v7}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v6, v0}, Lcom/android/server/am/ActivityStack;->SendToPermission(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 4512
    .end local v0           #mPackageName:Ljava/lang/String;
    :cond_8
    invoke-virtual {p0, v7, p3}, Lcom/android/server/am/ActivityStack;->updateTransitLocked(ILandroid/os/Bundle;)V
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    iget-object v2, v0, Lcom/android/server/am/ActivityStack;->mPower:Landroid/os/PowerManager;

    invoke-virtual {v2}, Landroid/os/PowerManager;->getSceneBacklightSwitcher()Z
    ...
    .line 671
    invoke-virtual/range {p1 .. p1}, Lcom/android/server/am/ActivityRecord;->checkapp()V
    ...
    iget-boolean v2, v0, Lcom/android/server/am/ActivityRecord;->mSelect:Z
    ...
    invoke-virtual {v2, v3}, Landroid/os/PowerManager;->setPowerSaving(Z)V
...
.method final removeActivityFromHistoryLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {p0, p1, v0, v2}, Lcom/android/server/am/ActivityStack;->finishActivityResultsLocked(Lcom/android/server/am/ActivityRecord;ILandroid/content/Intent;)V
...
.method final requestFinishActivityLocked(Landroid/os/IBinder;ILandroid/content/Intent;Ljava/lang/String;Z)Z
    ...
    .line 3820
    sget-object v7, Lcom/android/server/am/ActivityStack;->mExtraPersistentActivities:[Ljava/lang/String;
    ...
    .line 3821
    .local v10, persistent:Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, v3}, Lcom/android/server/am/ActivityManagerService;->moveActivityTaskToBack(Landroid/os/IBinder;Z)Z
    ...
    .end local v8           #i$:I
    .end local v9           #len$:I
    .end local v10           #persistent:Ljava/lang/String;
    :cond_2
    move-object v0, p0
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    invoke-virtual {v3, v4, v7, v8}, Lcom/android/server/am/AppDvfsAdapter;->setProfile(III)V
    ...
    invoke-virtual {v3, v7, v8}, Lcom/android/server/am/AppDvfsAdapter;->closeProfile(J)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/server/am/ActivityStack;->SendIntentToPmqos(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v4, "ActvPolicyClose"
    ...
    invoke-static {v3, v4, v7}, Landroid/util/LogPower;->push(ILjava/lang/String;Ljava/lang/String;)I
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/server/am/ActivityStack;->SendToPermission(Landroid/content/Context;Ljava/lang/String;)V
