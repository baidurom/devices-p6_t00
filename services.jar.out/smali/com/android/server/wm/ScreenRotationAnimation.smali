...
.method private startAnimation(Landroid/view/SurfaceSession;JFIIZ)Z
    ...
    .line 398
    .local v12, hwextContext:Landroid/content/Context;
    const/4 v14, 0x0

    .local v14, rotateExitAnimationId:I
    const/4 v13, 0x0

    .line 400
    .local v13, rotateEnterAnimationId:I
    :try_start_0
    move-object/from16 v0, p0
    ...
    const-string v15, "androidhwext"

    invoke-virtual {v2, v3, v6, v15}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 412
    invoke-static {v12, v14}, Landroid/view/animation/AnimationUtils;->loadAnimation(Landroid/content/Context;I)Landroid/view/animation/Animation;
    ...
    .line 497
    .end local v12           #hwextContext:Landroid/content/Context;
    .end local v13           #rotateEnterAnimationId:I
    .end local v14           #rotateExitAnimationId:I
    :cond_6
    move-object/from16 v0, p0
    ...
    iget v15, v0, Lcom/android/server/wm/ScreenRotationAnimation;->mOriginalHeight:I

    mul-int/lit8 v15, v15, 0x2

    invoke-direct {v4, v2, v3, v6, v15}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v5, v2, v3, v6, v15}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    .restart local v12       #hwextContext:Landroid/content/Context;
    .restart local v13       #rotateEnterAnimationId:I
    .restart local v14       #rotateExitAnimationId:I
    :catch_2
    move-exception v2
