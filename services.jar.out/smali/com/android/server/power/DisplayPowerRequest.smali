...
.field public isUserAdjustingAutoBrightness:Z
...
.method public constructor <init>()V
    ...
    .line 81
    iput-boolean v1, p0, Lcom/android/server/power/DisplayPowerRequest;->useSmartBacklight:Z

    .line 84
    iput-boolean v1, p0, Lcom/android/server/power/DisplayPowerRequest;->isUserAdjustingAutoBrightness:Z
...
.method public copyFrom(Lcom/android/server/power/DisplayPowerRequest;)V
    ...
    .line 100
    iget-boolean v0, p1, Lcom/android/server/power/DisplayPowerRequest;->useSmartBacklight:Z

    iput-boolean v0, p0, Lcom/android/server/power/DisplayPowerRequest;->useSmartBacklight:Z

    .line 103
    iget-boolean v0, p1, Lcom/android/server/power/DisplayPowerRequest;->isUserAdjustingAutoBrightness:Z

    iput-boolean v0, p0, Lcom/android/server/power/DisplayPowerRequest;->isUserAdjustingAutoBrightness:Z
...
.method public equals(Lcom/android/server/power/DisplayPowerRequest;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/power/DisplayPowerRequest;->useSmartBacklight:Z

    iget-boolean v1, p1, Lcom/android/server/power/DisplayPowerRequest;->useSmartBacklight:Z

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Lcom/android/server/power/DisplayPowerRequest;->isUserAdjustingAutoBrightness:Z

    iget-boolean v1, p1, Lcom/android/server/power/DisplayPowerRequest;->isUserAdjustingAutoBrightness:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/android/server/power/DisplayPowerRequest;->useSmartBacklight:Z

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, ", isUserAdjustingAutoBrightness ="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v1, p0, Lcom/android/server/power/DisplayPowerRequest;->isUserAdjustingAutoBrightness:Z
