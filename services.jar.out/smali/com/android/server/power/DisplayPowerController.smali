...
# static fields
.field private static final APICAL_INDOOR_UI:I = 0x1

.field private static final APICAL_OUTDOOR_SENSOR:I = 0x1f40

.field private static final APICAL_OUTDOOR_UI:I = 0x2

.field private static final APICAL_OUT_TO_INDOOR_SENSOR:I = 0x1388
...
.field private static final MSG_SMART_LIGHT_SENSOR_DEBOUNCED:I = 0x4
...
.field private mIsCameraUi:Z

.field private mLastApicalFlag:I
...
.field private mLastestSmartSensorValue:I
...
.field private mSmartBackLightApicalDecrease:Z

.field private mSmartBackLightApicalIncrease:Z

.field private mSmartBackLightEnabled:Z

.field private final mSmartBackLightSensorListener:Landroid/hardware/SensorEventListener;

.field private mSmartBacklightLightSensor:Landroid/hardware/Sensor;

.field private mSmartBacklightLightSensorEnabled:Z

.field private mSmartLightSensorEnableTime:J

.field private mSmartSensorPendingValue:F
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/power/Notifier;Lcom/android/server/LightsService;Lcom/android/server/TwilightService;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayManagerService;Lcom/android/server/power/DisplayBlanker;Lcom/android/server/power/DisplayPowerController$Callbacks;Landroid/os/Handler;)V
    ...
    iput v5, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorValue:F
    ...
    iput-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightSensorListener:Landroid/hardware/SensorEventListener;
    ...
    iput-boolean v5, p0, Lcom/android/server/power/DisplayPowerController;->mIsCameraUi:Z

    .line 1628
    const/4 v5, 0x0

    iput v5, p0, Lcom/android/server/power/DisplayPowerController;->mLastApicalFlag:I

    .line 1636
    const/4 v5, -0x1

    iput v5, p0, Lcom/android/server/power/DisplayPowerController;->mLastestSmartSensorValue:I

    .line 1637
    const/4 v5, 0x0

    iput v5, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorPendingValue:F

    .line 1638
    const/4 v5, 0x0

    iput-boolean v5, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightApicalDecrease:Z

    .line 1639
    const/4 v5, 0x0

    iput-boolean v5, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightApicalIncrease:Z

    .line 1640
    const-wide/16 v5, -0x1

    iput-wide v5, p0, Lcom/android/server/power/DisplayPowerController;->mSmartLightSensorEnableTime:J
    ...
    iput-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mScreenAutoBrightnessHWSpline:Landroid/util/HwCustomSpline;

    .line 424
    iget-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mScreenAutoBrightnessHWSpline:Landroid/util/HwCustomSpline;
    ...
    iput-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBacklightLightSensor:Landroid/hardware/Sensor;
...
.method static synthetic access$100(Lcom/android/server/power/DisplayPowerController;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 72
    iget-boolean v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBacklightLightSensorEnabled:Z

    return v0
.end method

.method static synthetic access$1000(Lcom/android/server/power/DisplayPowerController;)Lcom/android/server/power/DisplayPowerState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1200(Lcom/android/server/power/DisplayPowerController;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 72
    invoke-direct {p0, p1}, Lcom/android/server/power/DisplayPowerController;->apicalAdjustment(I)V
...
.method static synthetic access$1300(Lcom/android/server/power/DisplayPowerController;)F
    ...
    .prologue
    .line 72
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorPendingValue:F
...
.method static synthetic access$1302(Lcom/android/server/power/DisplayPowerController;F)F
    ...
    .prologue
    .line 72
    iput p1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorPendingValue:F

    return p1
.end method

.method static synthetic access$1400(Lcom/android/server/power/DisplayPowerController;)Lcom/android/server/power/DisplayPowerController$Callbacks;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1500(Lcom/android/server/power/DisplayPowerController;Ljava/io/PrintWriter;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1800(Lcom/android/server/power/DisplayPowerController;)V
    .locals 0
    .parameter "x0"
...
.method static synthetic access$1900(Lcom/android/server/power/DisplayPowerController;)V
    ...
    .prologue
    .line 72
    invoke-direct {p0}, Lcom/android/server/power/DisplayPowerController;->debounceSmartLightSensor()V
...
.method static synthetic access$200(Lcom/android/server/power/DisplayPowerController;)Z
    ...
    .prologue
    .line 72
    iget-boolean v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightEnabled:Z
...
.method static synthetic access$2100(Lcom/android/server/power/DisplayPowerController;)F
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2200(Lcom/android/server/power/DisplayPowerController;JZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2300(Lcom/android/server/power/DisplayPowerController;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2400(Lcom/android/server/power/DisplayPowerController;JF)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2502(Lcom/android/server/power/DisplayPowerController;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$302(Lcom/android/server/power/DisplayPowerController;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 72
    iput p1, p0, Lcom/android/server/power/DisplayPowerController;->mLastestSmartSensorValue:I

    return p1
.end method

.method static synthetic access$400(Lcom/android/server/power/DisplayPowerController;)F
    .locals 1
    .parameter "x0"

    .prologue
    .line 72
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorValue:F

    return v0
.end method

.method static synthetic access$402(Lcom/android/server/power/DisplayPowerController;F)F
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 72
    iput p1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorValue:F

    return p1
.end method

.method static synthetic access$500(Lcom/android/server/power/DisplayPowerController;)J
    .locals 2
    .parameter "x0"

    .prologue
    .line 72
    iget-wide v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartLightSensorEnableTime:J

    return-wide v0
.end method

.method static synthetic access$600(Lcom/android/server/power/DisplayPowerController;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$700(Lcom/android/server/power/DisplayPowerController;)Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$800(Lcom/android/server/power/DisplayPowerController;)Z
    ...
    .prologue
    .line 72
    iget-boolean v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightApicalIncrease:Z
...
.method static synthetic access$802(Lcom/android/server/power/DisplayPowerController;Z)Z
    ...
    .prologue
    .line 72
    iput-boolean p1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightApicalIncrease:Z
...
.method static synthetic access$900(Lcom/android/server/power/DisplayPowerController;)Z
    ...
    .prologue
    .line 72
    iget-boolean v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightApicalDecrease:Z
...
.method static synthetic access$902(Lcom/android/server/power/DisplayPowerController;Z)Z
    ...
    .prologue
    .line 72
    iput-boolean p1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightApicalDecrease:Z
...
.method private apicalAdjustment(I)V
    .locals 4
    ...
    .line 1651
    :goto_0
    iget v1, p0, Lcom/android/server/power/DisplayPowerController;->mLastApicalFlag:I
    ...
    const-string v3, "APICAL call sendSmartBackLight flag = "
    ...
    .line 1654
    iget-object v1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLight:Lcom/android/server/LightsService$Light;

    invoke-virtual {v1, p1}, Lcom/android/server/LightsService$Light;->sendSmartBackLight(I)V

    .line 1655
    iput v0, p0, Lcom/android/server/power/DisplayPowerController;->mLastApicalFlag:I
...
.method private debounceSmartLightSensor()V
    .locals 3
    ...
    .line 1661
    iget-boolean v1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBacklightLightSensorEnabled:Z

    if-eqz v1, :cond_0

    .line 1662
    iget v1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorPendingValue:F

    float-to-int v0, v1

    .line 1663
    .local v0, value:I
    iput-boolean v2, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightApicalIncrease:Z

    .line 1664
    iput-boolean v2, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightApicalDecrease:Z
    ...
    const-string v2, "dropping mSmartBackLightSensorListener  onSensorChanged because screen is off"
    ...
    :cond_1
    iget v1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorValue:F
    ...
    iput v1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorValue:F

    .line 1674
    invoke-direct {p0, v0}, Lcom/android/server/power/DisplayPowerController;->apicalAdjustment(I)V
...
.method private initialize()V
    ...
    iput-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLight:Lcom/android/server/LightsService$Light;
...
.method private setSmartBacklightLightSensorEnabled(Z)V
    .locals 4
    .parameter "enable"
    ...
    iput-boolean v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBacklightLightSensorEnabled:Z

    .line 1040
    iget-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLight:Lcom/android/server/LightsService$Light;

    iget-boolean v1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBacklightLightSensorEnabled:Z

    invoke-virtual {v0, v1}, Lcom/android/server/LightsService$Light;->setSBLEnable(Z)V

    .line 1043
    iput v2, p0, Lcom/android/server/power/DisplayPowerController;->mLastApicalFlag:I

    .line 1044
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mLastestSmartSensorValue:I
    ...
    iput v0, p0, Lcom/android/server/power/DisplayPowerController;->mLastestSmartSensorValue:I
    ...
    iput v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorPendingValue:F
    ...
    iput-wide v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartLightSensorEnableTime:J

    .line 1052
    iget-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mSensorManager:Landroid/hardware/SensorManager;

    iget-object v1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightSensorListener:Landroid/hardware/SensorEventListener;

    iget-object v2, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBacklightLightSensor:Landroid/hardware/Sensor;
    ...
    .line 1058
    iput-boolean v2, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBacklightLightSensorEnabled:Z
...
.method private updatePowerState()V
    ...
    .line 737
    :cond_7
    iget-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBacklightLightSensor:Landroid/hardware/Sensor;
    ...
    iget-boolean v1, v1, Lcom/android/server/power/DisplayPowerRequest;->useSmartBacklight:Z
    ...
    iget-boolean v0, v0, Lcom/android/server/power/DisplayPowerRequest;->useSmartBacklight:Z

    iput-boolean v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightEnabled:Z

    .line 741
    iget-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLight:Lcom/android/server/LightsService$Light;

    iget-boolean v1, p0, Lcom/android/server/power/DisplayPowerController;->mSmartBackLightEnabled:Z
    ...
    :goto_6
    invoke-direct {p0, v0}, Lcom/android/server/power/DisplayPowerController;->setSmartBacklightLightSensorEnabled(Z)V
    ...
    iput v0, p0, Lcom/android/server/power/DisplayPowerController;->mSmartSensorValue:F
    ...
    iget-boolean v1, p0, Lcom/android/server/power/DisplayPowerController;->mElectronBeamFadesConfig:Z
    ...
    :cond_22
    invoke-virtual {v0, v12}, Lcom/android/server/power/DisplayPowerState;->prepareElectronBeam(I)Z
