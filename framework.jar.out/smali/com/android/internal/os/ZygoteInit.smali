...
.field private static final PRELOAD_SPEEDUP:Z = false
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 280
    const-string/jumbo v0, "persist.sys.coldbootspeedup"
    ...
    sput-boolean v0, Lcom/android/internal/os/ZygoteInit;->PRELOAD_SPEEDUP:Z
...
.method private static preloadClasses()V
    ...
    .line 423
    sget-boolean v4, Lcom/android/internal/os/ZygoteInit;->PRELOAD_SPEEDUP:Z
    ...
    invoke-direct {v0, v4}, Lcom/android/internal/os/PrealoadClassThread;-><init>(Ljava/lang/String;)V

    .line 426
    .local v0, preloadClassThread:Ljava/lang/Thread;
    ...
    .line 442
    .end local v0           #preloadClassThread:Ljava/lang/Thread;
    :goto_0
    return-void
    ...
    const-string/jumbo v4, "preloaded-classes1"

    invoke-direct {v2, v4}, Lcom/android/internal/os/PrealoadClassThread;-><init>(Ljava/lang/String;)V

    .line 432
    .local v2, preloadClassThread1:Ljava/lang/Thread;
    new-instance v3, Lcom/android/internal/os/PrealoadClassThread;

    const-string/jumbo v4, "preloaded-classes2"

    invoke-direct {v3, v4}, Lcom/android/internal/os/PrealoadClassThread;-><init>(Ljava/lang/String;)V

    .line 433
    .local v3, preloadClassThread2:Ljava/lang/Thread;
    new-instance v1, Lcom/android/internal/os/PrealoadClassThread;

    const-string/jumbo v4, "preloaded-classes0"

    invoke-direct {v1, v4}, Lcom/android/internal/os/PrealoadClassThread;-><init>(Ljava/lang/String;)V

    .line 435
    .local v1, preloadClassThread0:Ljava/lang/Thread;
...
.method private static preloadResources()V
    ...
    invoke-virtual {v9}, Landroid/content/res/Resources;->startPreloading()V

    .line 460
    sget-boolean v9, Lcom/android/internal/os/ZygoteInit;->PRELOAD_SPEEDUP:Z
    ...
    const-string v10, "Preloading resources..."

    invoke-static {v9, v10}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 462
    new-instance v3, Lcom/android/internal/os/PreloadResourceThread2;

    invoke-direct {v3, v6}, Lcom/android/internal/os/PreloadResourceThread2;-><init>(Ldalvik/system/VMRuntime;)V

    .line 466
    .local v3, preloadResourceThread:Ljava/lang/Thread;
    const/4 v9, 0x1

    invoke-virtual {v3, v9}, Ljava/lang/Thread;->setPriority(I)V
    ...
    .line 502
    .end local v3           #preloadResourceThread:Ljava/lang/Thread;
    :goto_0
    ...
    invoke-direct {v4, v6, v9}, Lcom/android/internal/os/PreloadResourceThread;-><init>(Ldalvik/system/VMRuntime;I)V

    .line 475
    .local v4, preloadResourceThread0:Ljava/lang/Thread;
    new-instance v5, Lcom/android/internal/os/PreloadResourceThread;

    const/4 v9, 0x1

    invoke-direct {v5, v6, v9}, Lcom/android/internal/os/PreloadResourceThread;-><init>(Ldalvik/system/VMRuntime;I)V

    .line 476
    .local v5, preloadResourceThread1:Ljava/lang/Thread;
    const/16 v9, 0xa
    ...
    invoke-static {v6, v1}, Lcom/android/internal/os/ZygoteInit;->preloadColorStateLists(Ldalvik/system/VMRuntime;Landroid/content/res/TypedArray;)I
    ...
    const-string/jumbo v11, "preloaded "
    ...
    const-string v11, "color resources in "
    ...
    .end local v4           #preloadResourceThread0:Ljava/lang/Thread;
    .end local v5           #preloadResourceThread1:Ljava/lang/Thread;
    ...
    .restart local v4       #preloadResourceThread0:Ljava/lang/Thread;
    .restart local v5       #preloadResourceThread1:Ljava/lang/Thread;
