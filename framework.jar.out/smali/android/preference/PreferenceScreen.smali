...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/preference/PreferenceScreen$HwDialog;,
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v0, p0, Landroid/preference/PreferenceScreen;->mIsHwActionBar:Z

    .line 110
    invoke-direct {p0, p1, p2}, Landroid/preference/PreferenceScreen;->initHwTheme(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private initHwTheme(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v4, p0, Landroid/preference/PreferenceScreen;->mIsHwActionBar:Z
...
.method private showDialog(Landroid/os/Bundle;)V
    ...
    iget-boolean v5, p0, Landroid/preference/PreferenceScreen;->mIsHwActionBar:Z

    if-eqz v5, :cond_2

    new-instance v2, Landroid/preference/PreferenceScreen$HwDialog;

    invoke-virtual {v1}, Landroid/content/Context;->getThemeResId()I

    move-result v5

    invoke-direct {v2, v1, v5}, Landroid/preference/PreferenceScreen$HwDialog;-><init>(Landroid/content/Context;I)V
