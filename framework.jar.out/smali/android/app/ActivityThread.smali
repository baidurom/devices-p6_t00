...
.method final applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)I
    ...
    .line 3834
    invoke-virtual {p0, v11, v12}, Landroid/app/ActivityThread;->getDisplayMetricsLocked(ILandroid/content/res/CompatibilityInfo;)Landroid/util/DisplayMetrics;
    ...
    .line 3875
    invoke-virtual {p0, v2, v12}, Landroid/app/ActivityThread;->getDisplayMetricsLocked(ILandroid/content/res/CompatibilityInfo;)Landroid/util/DisplayMetrics;
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-virtual {v6}, Landroid/view/WindowManagerGlobal;->trimLocalMemory()V
...
.method final performPauseActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZZ)Landroid/os/Bundle;
    ...
    .line 3012
    iget-boolean v7, p1, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z
    ...
    iput-boolean v11, v7, Landroid/app/Activity;->mFinished:Z
    ...
    :try_start_1
    invoke-virtual {v6, v7}, Landroid/os/Bundle;->setAllowFds(Z)Z
    ...
    invoke-virtual {v7, v8, v6}, Landroid/app/Instrumentation;->callActivityOnSaveInstanceState(Landroid/app/Activity;Landroid/os/Bundle;)V

    .line 3034
    iput-object v6, p1, Landroid/app/ActivityThread$ActivityClientRecord;->state:Landroid/os/Bundle;
    :try_end_1
    .catch Landroid/app/SuperNotCalledException; {:try_start_1 .. :try_end_1} :catch_3
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_2
    ...
    const-string v7, "android.ActivityState.CHANGE"
    ...
    iget-object v8, p1, Landroid/app/ActivityThread$ActivityClientRecord;->activityInfo:Landroid/content/pm/ActivityInfo;
    ...
    .line 3050
    new-instance v7, Landroid/app/SuperNotCalledException;
    ...
    invoke-direct {v7, v8}, Landroid/app/SuperNotCalledException;-><init>(Ljava/lang/String;)V
    ...
    .line 3072
    .local v3, listeners:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/app/OnActivityPausedListener;>;"
    monitor-exit v8
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    check-cast v7, Landroid/app/OnActivityPausedListener;

    iget-object v8, p1, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;

    invoke-interface {v7, v8}, Landroid/app/OnActivityPausedListener;->onPaused(Landroid/app/Activity;)V
    ...
    .line 3072
    .end local v1           #i:I
    .end local v3           #listeners:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/app/OnActivityPausedListener;>;"
    .end local v4           #size:I
    :catchall_0
    move-exception v7
...
.method public final performResumeActivity(Landroid/os/IBinder;Z)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    const-string v3, "android.ActivityState.CHANGE"
    ...
    const-string v4, "Cannot broadcast before boot completed"
