...
.method private persistVolume(Landroid/media/AudioService$VolumeStreamState;II)V
    ...
    invoke-virtual {p1, v6, p3}, Landroid/media/AudioService$VolumeStreamState;->getSettingNameForDevice(ZI)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p1, p3, v6}, Landroid/media/AudioService$VolumeStreamState;->getIndex(IZ)I
    ...
    invoke-static {p1}, Landroid/media/AudioService$VolumeStreamState;->access$4700(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    const-string/jumbo v1, "persist.sys.ring.index"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$5500(Landroid/media/AudioService;)Landroid/media/AudioSystem$ErrorCallback;
    ...
    invoke-static {v15}, Landroid/media/AudioService$VolumeStreamState;->access$5800(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static {v2, v1, v3}, Landroid/media/AudioService;->access$6800(Landroid/media/AudioService;Landroid/media/AudioService$RemoteControlStackEntry;I)V
    ...
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$8002(Landroid/media/AudioService;I)I
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8200(Landroid/media/AudioService;)V
    ...
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$4002(Landroid/media/AudioService;Z)Z
    ...
    invoke-static {v1, v2, v3}, Landroid/media/AudioService;->access$8302(Landroid/media/AudioService;J)J
    ...
    invoke-static {v1, v2, v3, v4}, Landroid/media/AudioService;->access$8400(Landroid/media/AudioService;IJ)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8700(Landroid/media/AudioService;)Z
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$8900(Landroid/media/AudioService;)Landroid/app/AlertDialog;

    move-result-object v2

    #setter for: Landroid/media/AudioService;->mAlertDialog:Landroid/app/AlertDialog;
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$8802(Landroid/media/AudioService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8800(Landroid/media/AudioService;)Landroid/app/AlertDialog;
    ...
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$8702(Landroid/media/AudioService;Z)Z
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$9000(Landroid/media/AudioService;)Landroid/app/NotificationManager;
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$9100(Landroid/media/AudioService;)Landroid/content/Context;
