...
.method static synthetic access$8100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 372
    invoke-direct {p0, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->sendP2pConnectionStateBroadcast(I)V
...
.method private addRowToDialog(Landroid/view/ViewGroup;ILjava/lang/String;)V
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->eContext:Landroid/view/ContextThemeWrapper;
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$12000(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/view/ContextThemeWrapper;
...
.method private isForegroundApp(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$13100(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/app/ActivityManager;
...
.method private notifyInvitationReceived()V
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->eContext:Landroid/view/ContextThemeWrapper;
    invoke-static {v6}, Landroid/net/wifi/p2p/WifiP2pService;->access$12000(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/view/ContextThemeWrapper;
...
.method private notifyInvitationSent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->eContext:Landroid/view/ContextThemeWrapper;
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$12000(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/view/ContextThemeWrapper;
...
.method private sendConnectNoticeToApp(Landroid/net/wifi/p2p/WifiP2pDevice;Landroid/net/wifi/p2p/WifiP2pConfig;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$13000(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/lang/String;
...
.method private sendDetachedMsg(I)V
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12900(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/os/Messenger;
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$12902(Landroid/net/wifi/p2p/WifiP2pService;Landroid/os/Messenger;)Landroid/os/Messenger;

    .line 2747
    iget-object v1, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mForegroundAppPkgName:Ljava/lang/String;
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$13002(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/String;)Ljava/lang/String;
...
.method private sendP2pConnectionStateBroadcast(I)V
    .locals 7
    .parameter "state"
    ...
    iget-object v4, v5, Landroid/net/wifi/p2p/WifiP2pConfig;->deviceAddress:Ljava/lang/String;

    .line 1863
    .local v4, opposeInterfaceAddressString:Ljava/lang/String;
    const/4 v0, 0x0

    .line 1864
    .local v0, conDeviceName:Ljava/lang/String;
    const-string v5, "interfaceAddress"
    ...
    .end local v1           #d:Landroid/net/wifi/p2p/WifiP2pDevice;
    :cond_1
    const-string/jumbo v5, "oppDeviceName"
    ...
    const-string/jumbo v6, "oppDeviceName = "
    ...
    const-string/jumbo v6, "opposeInterfaceAddressString = "
    ...
    .line 1878
    .end local v0           #conDeviceName:Ljava/lang/String;
    .end local v2           #i$:Ljava/util/Iterator;
    .end local v4           #opposeInterfaceAddressString:Ljava/lang/String;
    :goto_0
    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;
    ...
    .line 1876
    :cond_2
    const-string v5, "GroupCreatedState:mSavedConnectConfig is null"
...
.method private setDialogListenerApp(Landroid/os/Messenger;Ljava/lang/String;Z)Z
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mForegroundAppMessenger:Landroid/os/Messenger;
    invoke-static {v0, v3}, Landroid/net/wifi/p2p/WifiP2pService;->access$12902(Landroid/net/wifi/p2p/WifiP2pService;Landroid/os/Messenger;)Landroid/os/Messenger;

    .line 2834
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mForegroundAppPkgName:Ljava/lang/String;
    invoke-static {v0, v3}, Landroid/net/wifi/p2p/WifiP2pService;->access$13002(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/String;)Ljava/lang/String;
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mForegroundAppMessenger:Landroid/os/Messenger;
    invoke-static {v0, p1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12902(Landroid/net/wifi/p2p/WifiP2pService;Landroid/os/Messenger;)Landroid/os/Messenger;

    .line 2843
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mForegroundAppPkgName:Ljava/lang/String;
    invoke-static {v0, p2}, Landroid/net/wifi/p2p/WifiP2pService;->access$13002(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/String;)Ljava/lang/String;
