...
.method private setScanAlarm(Z)V
    ...
    invoke-static {v6}, Landroid/net/wifi/WifiStateMachine;->access$16700(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mScanIntent:Landroid/app/PendingIntent;
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$16700(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
...
.method public enter()V
    ...
    #setter for: Landroid/net/wifi/WifiStateMachine;->dynamic_scan_cnt:I
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$16902(Landroid/net/wifi/WifiStateMachine;I)I

    .line 3862
    iget-object v0, p0, Landroid/net/wifi/WifiStateMachine$DisconnectedState;->this$0:Landroid/net/wifi/WifiStateMachine;

    invoke-virtual {v0}, Landroid/net/wifi/WifiStateMachine;->dyscanScanCntDisconnect()V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v7}, Landroid/net/wifi/WifiStateMachine;->access$17000(Landroid/net/wifi/WifiStateMachine;)I
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mPSEnable:Z
    invoke-static {v6}, Landroid/net/wifi/WifiStateMachine;->access$17100(Landroid/net/wifi/WifiStateMachine;)Z
    ...
    invoke-virtual {v6}, Landroid/net/wifi/WifiStateMachine;->dyscanScanCntDisconnect()V
    ...
    #setter for: Landroid/net/wifi/WifiStateMachine;->dynamic_scan_cnt:I
    invoke-static {v6, v8}, Landroid/net/wifi/WifiStateMachine;->access$16902(Landroid/net/wifi/WifiStateMachine;I)I
    ...
    invoke-static {v6, v7}, Landroid/net/wifi/WifiStateMachine;->access$9200(Landroid/net/wifi/WifiStateMachine;Landroid/net/NetworkInfo$DetailedState;)V
    ...
    :goto_2
    :sswitch_9
    const-string/jumbo v6, "ro.config.autoconnect.swich"
    ...
    const-string/jumbo v8, "the mTemporarilyDisconnectWifi:"
    ...
    invoke-static {v10}, Landroid/net/wifi/WifiStateMachine;->access$17004(Landroid/net/wifi/WifiStateMachine;)I

    move-result v10

    invoke-virtual {v7, v9, v10, v8}, Landroid/net/wifi/WifiStateMachine;->obtainMessage(III)Landroid/os/Message;
    ...
    invoke-static {v9}, Landroid/net/wifi/WifiStateMachine;->access$6300(Landroid/net/wifi/WifiStateMachine;)J

    move-result-wide v9

    invoke-virtual {v6, v7, v9, v10}, Landroid/net/wifi/WifiStateMachine;->sendMessageDelayed(Landroid/os/Message;J)V
