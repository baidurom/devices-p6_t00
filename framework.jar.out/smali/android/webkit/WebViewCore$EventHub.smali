...
.field static final CLEAR_TEXT:I = 0xd8
...
.field static final PUSH_STATE:I = 0xe3
...
.field private mUIBlockMessages:Z
...
.method static synthetic access$1300(Landroid/webkit/WebViewCore$EventHub;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1302(Landroid/webkit/WebViewCore$EventHub;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7700(Landroid/webkit/WebViewCore$EventHub;Landroid/os/Message;J)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$7800(Landroid/webkit/WebViewCore$EventHub;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private declared-synchronized removeMessages(I)V
    ...
    #setter for: Landroid/webkit/WebViewCore;->mDrawIsScheduled:Z
    invoke-static {v2, v3}, Landroid/webkit/WebViewCore;->access$7202(Landroid/webkit/WebViewCore;Z)Z
...
.method private declared-synchronized sendMessage(Landroid/os/Message;)V
    ...
    :cond_1
    :try_start_1
    iget-boolean v1, p0, Landroid/webkit/WebViewCore$EventHub;->mUIBlockMessages:Z
    ...
    .line 1879
    iget-object v1, p0, Landroid/webkit/WebViewCore$EventHub;->mMessages:Ljava/util/LinkedList;
...
# virtual methods
.method public declared-synchronized blockUIMessages()V
    .locals 1
    ...
    :try_start_0
    iput-boolean v0, p0, Landroid/webkit/WebViewCore$EventHub;->mUIBlockMessages:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public dispatchWebKitEvent(Landroid/webkit/WebViewInputDispatcher;Landroid/view/MotionEvent;II)Z
    ...
    invoke-static {v1, v13, v14, v2, v3}, Landroid/webkit/WebViewCore;->access$3800(Landroid/webkit/WebViewCore;IIIZ)Landroid/webkit/WebViewCore$WebKitHitTest;
    ...
    #getter for: Landroid/webkit/WebViewCore;->mWebViewClassic:Landroid/webkit/WebViewClassic;
    invoke-static {v1}, Landroid/webkit/WebViewCore;->access$1200(Landroid/webkit/WebViewCore;)Landroid/webkit/WebViewClassic;
    ...
    invoke-static {v1, v2}, Landroid/webkit/WebViewCore;->access$7000(Landroid/webkit/WebViewCore;I)Z
    ...
    invoke-static/range {v1 .. v9}, Landroid/webkit/WebViewCore;->access$7100(Landroid/webkit/WebViewCore;II[I[I[IIII)I
    ...
    .line 1855
    invoke-virtual {p0}, Landroid/webkit/WebViewCore$EventHub;->unblockUIMessages()V
...
.method public findTouchNodeAt(II)Z
    .locals 2
    .parameter "x"
    .parameter "y"
    ...
    #calls: Landroid/webkit/WebViewCore;->nativeFindTouchNodeAt(III)Z
    invoke-static {v0, v1, p1, p2}, Landroid/webkit/WebViewCore;->access$7400(Landroid/webkit/WebViewCore;III)Z
...
.method public focusIsPlugin(II)Z
    .locals 2
    .parameter "x"
    .parameter "y"
    ...
    #calls: Landroid/webkit/WebViewCore;->nativeFocusIsPlugin(III)Z
    invoke-static {v0, v1, p1, p2}, Landroid/webkit/WebViewCore;->access$7300(Landroid/webkit/WebViewCore;III)Z
...
.method public declared-synchronized removeUIMessages()V
    .locals 1
    ...
    :try_start_0
    invoke-direct {p0, v0}, Landroid/webkit/WebViewCore$EventHub;->removeMessages(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized unblockUIMessages()V
    .locals 3
    ...
    :try_start_0
    iget-boolean v0, p0, Landroid/webkit/WebViewCore$EventHub;->mUIBlockMessages:Z
