...
.method public clearPreviousHitTest()V
    ...
    invoke-static {v0, v1}, Landroid/webkit/WebViewClassic;->access$7100(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewCore$WebKitHitTest;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$3600(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewDatabaseClassic;
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$4102(Landroid/webkit/WebViewClassic;Z)Z
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mAutoScrollX:I
    invoke-static {v8}, Landroid/webkit/WebViewClassic;->access$3900(Landroid/webkit/WebViewClassic;)I
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mAutoScrollY:I
    invoke-static/range {v40 .. v40}, Landroid/webkit/WebViewClassic;->access$4000(Landroid/webkit/WebViewClassic;)I
    ...
    invoke-static {v3, v8, v0, v1, v2}, Landroid/webkit/WebViewClassic;->access$4300(Landroid/webkit/WebViewClassic;IIZI)Z
    ...
    invoke-static {v8}, Landroid/webkit/WebViewClassic;->access$4400(Landroid/webkit/WebViewClassic;)Landroid/graphics/Rect;
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mAutoScrollX:I
    invoke-static/range {v40 .. v40}, Landroid/webkit/WebViewClassic;->access$3900(Landroid/webkit/WebViewClassic;)I
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mScrollingLayerRect:Landroid/graphics/Rect;
    invoke-static/range {v40 .. v40}, Landroid/webkit/WebViewClassic;->access$4400(Landroid/webkit/WebViewClassic;)Landroid/graphics/Rect;
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mAutoScrollY:I
    invoke-static/range {v41 .. v41}, Landroid/webkit/WebViewClassic;->access$4000(Landroid/webkit/WebViewClassic;)I
    ...
    invoke-static {v3, v8, v0}, Landroid/webkit/WebViewClassic;->access$4500(Landroid/webkit/WebViewClassic;II)V
    ...
    invoke-static {v8, v0, v1, v3}, Landroid/webkit/WebViewClassic;->access$4600(Landroid/webkit/WebViewClassic;IIZ)V
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$4700(Landroid/webkit/WebViewClassic;)Landroid/webkit/ZoomManager;
    ...
    invoke-static {v3, v8, v14, v0}, Landroid/webkit/WebViewClassic;->access$4800(Landroid/webkit/WebViewClassic;ILjava/lang/String;Z)V
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$4900(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore$DrawData;
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mDelaySetPicture:Landroid/webkit/WebViewCore$DrawData;
    invoke-static {v8}, Landroid/webkit/WebViewClassic;->access$4900(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore$DrawData;
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$4902(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewCore$DrawData;)Landroid/webkit/WebViewCore$DrawData;
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$5200(IZ)V
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$5302(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewInputDispatcher;)Landroid/webkit/WebViewInputDispatcher;
    ...
    invoke-static {v8, v0, v1, v3}, Landroid/webkit/WebViewClassic;->access$5500(Landroid/webkit/WebViewClassic;IILandroid/webkit/WebViewCore$TextSelectionData;)V
    ...
    invoke-static {v3, v8, v0, v1, v2}, Landroid/webkit/WebViewClassic;->access$5600(Landroid/webkit/WebViewClassic;IIII)V
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$5300(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewInputDispatcher;
    ...
    :goto_4
    invoke-virtual {v8, v3}, Landroid/webkit/WebViewInputDispatcher;->setWebKitWantsPluginTouchEvents(Z)V
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$5900(Landroid/webkit/WebViewClassic;Z)V
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$6002(Landroid/webkit/WebViewClassic;I)I
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$6100(Landroid/webkit/WebViewClassic;)Landroid/webkit/HTML5VideoViewProxy;
    ...
    invoke-virtual {v3}, Landroid/webkit/ZoomManager;->isZoomAnimating()Z
    ...
    invoke-static {v3, v8, v10}, Landroid/os/Message;->obtain(Landroid/os/Handler;ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$6800(Landroid/webkit/WebViewClassic;)Landroid/webkit/AccessibilityInjector;
    ...
    invoke-static {v3, v0}, Landroid/webkit/WebViewClassic;->access$6902(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewCore$WebKitHitTest;)Landroid/webkit/WebViewCore$WebKitHitTest;
    ...
    invoke-static {v3, v0}, Landroid/webkit/WebViewClassic;->access$7000(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewCore$WebKitHitTest;)V
    ...
    invoke-static {v8, v3}, Landroid/webkit/WebViewClassic;->access$3502(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewCore$AutoFillData;)Landroid/webkit/WebViewCore$AutoFillData;
    ...
    invoke-static {v8}, Landroid/webkit/WebViewClassic;->access$3500(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore$AutoFillData;
    ...
    invoke-static {v8, v3}, Landroid/webkit/WebViewClassic;->access$7200(Landroid/webkit/WebViewClassic;Ljava/lang/String;)V
    ...
    invoke-static {v3, v8, v0}, Landroid/webkit/WebViewClassic;->access$7300(IILandroid/graphics/Rect;)V
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$7500(Landroid/webkit/WebViewClassic;)Landroid/webkit/FindActionModeCallback;
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$7600(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore$FindAllRequest;
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$7700(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebView$FindListener;
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$900(Landroid/webkit/WebViewClassic;)Z
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mMessageHandled:Z
    ...
    invoke-virtual {v3}, Landroid/webkit/WebViewClassic;->resumeTimers()V
    ...
    #setter for: Landroid/webkit/WebViewClassic;->mAllPaused:Z
    ...
    #setter for: Landroid/webkit/WebViewClassic;->mMessageHandled:Z
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$8402(Landroid/webkit/WebViewClassic;Z)Z
    ...
    invoke-virtual {v3, v8}, Landroid/webkit/WebViewCore;->sendMessage(I)V
...
.method public shouldInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$8700(Landroid/webkit/WebViewClassic;)Landroid/graphics/Rect;
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$8800(Landroid/webkit/WebViewClassic;)Landroid/graphics/Rect;
