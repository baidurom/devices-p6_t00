...
.method private parseApplication(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;)Z
    ...
    .line 1770
    .local v28, applicationList:[Ljava/lang/String;
    if-eqz v36, :cond_0
    ...
    .line 1781
    .local v35, manageSpaceActivity:Ljava/lang/String;
    if-eqz v35, :cond_1
    ...
    .line 1795
    .local v30, backupAgent:Ljava/lang/String;
    if-eqz v30, :cond_3
    ...
    .line 1815
    .end local v30           #backupAgent:Ljava/lang/String;
    :cond_3
    const/4 v3, 0x1
    ...
    .line 1817
    .local v47, v:Landroid/util/TypedValue;
    if-eqz v47, :cond_4
    ...
    .line 1818
    invoke-virtual/range {v47 .. v47}, Landroid/util/TypedValue;->coerceToString()Ljava/lang/CharSequence;
    ...
    .restart local v29       #arr$:[Ljava/lang/String;
    ...
    .line 2042
    .local v34, lname:Ljava/lang/String;
    const/4 v3, 0x1
    ...
    .line 2068
    .end local v34           #lname:Ljava/lang/String;
    .end local v39           #req:Z
    :cond_28
...
.method private parsePackage(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    .line 940
    .local v18, applicationScaledGL:[Ljava/lang/String;
    invoke-static {}, Landroid/content/res/Resources;->getSystem()Landroid/content/res/Resources;
    ...
    .line 942
    .local v20, applicationScaledSurface:[Ljava/lang/String;
    invoke-static {}, Landroid/content/res/Resources;->getSystem()Landroid/content/res/Resources;
    ...
    .line 945
    .local v19, applicationScaledPackage:[Ljava/lang/String;
    move-object/from16 v0, p2
    ...
    .line 1008
    .local v49, supportsSmallScreens:I
    const/16 v48, 0x1

    .line 1009
    .local v48, supportsNormalScreens:I
    const/16 v47, 0x1

    .line 1010
    .local v47, supportsLargeScreens:I
    const/16 v50, 0x1

    .line 1011
    .local v50, supportsXLargeScreens:I
    const/16 v42, 0x1

    .line 1012
    .local v42, resizeable:I
    const/16 v17, 0x1
    ...
    .line 1022
    .local v51, tagName:Ljava/lang/String;
    ...
    .line 1078
    new-instance v22, Landroid/content/pm/ConfigurationInfo;

    invoke-direct/range {v22 .. v22}, Landroid/content/pm/ConfigurationInfo;-><init>()V

    .line 1079
    .local v22, cPref:Landroid/content/pm/ConfigurationInfo;
    ...
    .line 1105
    .end local v22           #cPref:Landroid/content/pm/ConfigurationInfo;
    :cond_13
    ...
    .line 1106
    new-instance v25, Landroid/content/pm/FeatureInfo;

    invoke-direct/range {v25 .. v25}, Landroid/content/pm/FeatureInfo;-><init>()V
    ...
    .line 1131
    .restart local v22       #cPref:Landroid/content/pm/ConfigurationInfo;
    move-object/from16 v0, v25
    ...
    .line 1147
    .local v52, targetCode:Ljava/lang/String;
    const/4 v3, 0x0
    ...
    .end local v52           #targetCode:Ljava/lang/String;
    ...
    .restart local v52       #targetCode:Ljava/lang/String;
    .restart local v53       #targetVers:I
    .restart local v55       #val:Landroid/util/TypedValue;
    :cond_23
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .line 1344
    .end local v51           #tagName:Ljava/lang/String;
    :cond_33
    if-nez v26, :cond_34
    ...
    aget-object v44, v21, v27

    .line 1355
    .local v44, scaleApp:Ljava/lang/String;
    move-object/from16 v0, v41
    ...
    iget v5, v3, Landroid/content/pm/ApplicationInfo;->appScaleOptFlags:I

    or-int/lit8 v5, v5, 0x1

    iput v5, v3, Landroid/content/pm/ApplicationInfo;->appScaleOptFlags:I
    ...
    .line 1362
    .end local v44           #scaleApp:Ljava/lang/String;
    :cond_36
    ...
    .line 1363
    .restart local v44       #scaleApp:Ljava/lang/String;
    move-object/from16 v0, v41
    ...
    .line 1383
    .local v28, implicitPerms:Ljava/lang/StringBuilder;
    const/16 v30, 0x0
    ...
    .end local v28           #implicitPerms:Ljava/lang/StringBuilder;
    const/16 v3, 0x80
    ...
    .line 1392
    .restart local v28       #implicitPerms:Ljava/lang/StringBuilder;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;
    ...
    aget-object v40, v3, v29

    .line 1416
    .local v40, perm:Ljava/lang/String;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->requestedPermissions:Ljava/util/ArrayList;
    ...
    .line 1423
    .end local v29           #in:I
    .end local v40           #perm:Ljava/lang/String;
    .end local v45           #spi:Landroid/content/pm/PackageParser$SplitPermissionInfo;
    :cond_43
    if-ltz v49, :cond_44
