...
.method private checkPermission(Landroid/net/Uri;)Z
    .locals 14
    .parameter "uri"

    .prologue
    .line 1971
    new-instance v9, Lcom/huawei/permission/ContentPermission;

    iget-object v2, p0, Landroid/content/ContentResolver;->mContext:Landroid/content/Context;

    invoke-direct {v9, v2}, Lcom/huawei/permission/ContentPermission;-><init>(Landroid/content/Context;)V

    .line 1972
    .local v9, contentPermission:Lcom/huawei/permission/ContentPermission;
    invoke-virtual {v9, p1}, Lcom/huawei/permission/ContentPermission;->getContentType(Landroid/net/Uri;)I

    move-result v7

    .line 1973
    .local v7, Authority:I
    if-nez v7, :cond_0
    ...
    invoke-virtual {v9, v2}, Lcom/huawei/permission/ContentPermission;->isGlobalSwitchOn(Landroid/database/Cursor;)Z
    ...
    .line 1984
    :cond_1
    const-string v2, "content://com.huawei.permissionmanager.provider.PermissionDataProvider/permission"
    ...
    invoke-virtual {p0, v1}, Landroid/content/ContentResolver;->acquireProvider(Landroid/net/Uri;)Landroid/content/IContentProvider;
    ...
    const-string/jumbo v3, "remind: provider.query() returns cursor == null"
    ...
    const-string/jumbo v3, "remind: acquireProvider() returns provider == null"
    ...
    :cond_3
    invoke-virtual {v9, v10}, Lcom/huawei/permission/ContentPermission;->remind(Landroid/database/Cursor;)Z

    move-result v13

    .line 2009
    .local v13, remindSucess:Z
    ...
    const-string v3, "get permission: provider.query() returns cursor == null"
    ...
    .end local v11           #e:Landroid/os/RemoteException;
    :cond_5
    invoke-virtual {v9, v10}, Lcom/huawei/permission/ContentPermission;->getPermission(Landroid/database/Cursor;)I
    ...
    .line 2032
    invoke-virtual {v9, v8, v12}, Lcom/huawei/permission/ContentPermission;->sendIntentForNotify(II)V
    ...
    invoke-direct {p0, v0, v7, v8, v2}, Landroid/content/ContentResolver;->insertLog(Landroid/content/IContentProvider;IIZ)V
...
.method private final getDummyResult(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/content/IContentProvider;)Landroid/database/Cursor;
    .locals 13
    .parameter "uri"
    ...
    .line 2093
    .end local v9           #i:I
    .end local v11           #multiRow:I
    .end local v12           #singleRow:I
    :cond_4
    :goto_2
    if-eqz p3, :cond_5
    ...
    .line 2098
    .local v4, selectStr:Ljava/lang/String;
    :goto_3
    const/4 v7, 0x0
    ...
    .end local v4           #selectStr:Ljava/lang/String;
    :goto_4
    return-object v1
    ...
    .line 2078
    .restart local v11       #multiRow:I
    .restart local v12       #singleRow:I
    :cond_7
    :try_start_1
    aget-object v1, p2, v9
    ...
    .restart local v4       #selectStr:Ljava/lang/String;
    goto :goto_3
.end method
...
.method private insertLog(Landroid/content/IContentProvider;IIZ)V
    .locals 5
    .parameter "provider"
    ...
    const-string v4, "insert Log error, provider == null "
    ...
    .line 2123
    :try_start_0
    const-string v3, "content://com.huawei.permissionmanager.provider.PermissionDataProvider/log"
    ...
    .line 2124
    .local v2, permissionUri:Landroid/net/Uri;
    invoke-interface {p1, v2, v0}, Landroid/content/IContentProvider;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 2125
    .end local v2           #permissionUri:Landroid/net/Uri;
    :catch_0
    move-exception v1
...
.method public final delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p1}, Landroid/content/ContentResolver;->checkPermission(Landroid/net/Uri;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-direct/range {p0 .. p1}, Landroid/content/ContentResolver;->checkPermission(Landroid/net/Uri;)Z
    ...
    .line 371
    invoke-direct/range {v3 .. v9}, Landroid/content/ContentResolver;->getDummyResult(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/content/IContentProvider;)Landroid/database/Cursor;
    ...
    .line 381
    invoke-interface {v9}, Landroid/content/IContentProvider;->createCancellationSignal()Landroid/os/ICancellationSignal;
    ...
    invoke-virtual {v0, v15}, Landroid/os/CancellationSignal;->setRemote(Landroid/os/ICancellationSignal;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .line 386
    :try_start_1
    invoke-interface/range {v9 .. v15}, Landroid/content/IContentProvider;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/ICancellationSignal;)Landroid/database/Cursor;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 400
    .local v25, qCursor:Landroid/database/Cursor;
    :goto_1
    if-nez v25, :cond_7
    ...
    invoke-virtual {v0, v9}, Landroid/content/ContentResolver;->releaseUnstableProvider(Landroid/content/IContentProvider;)Z
    ...
    .line 388
    .end local v25           #qCursor:Landroid/database/Cursor;
    :catch_0
    move-exception v24
    ...
    invoke-virtual {v0, v9}, Landroid/content/ContentResolver;->unstableProviderDied(Landroid/content/IContentProvider;)V
    ...
    .line 397
    :try_start_3
    invoke-interface/range {v16 .. v22}, Landroid/content/IContentProvider;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/ICancellationSignal;)Landroid/database/Cursor;

    move-result-object v25

    .restart local v25       #qCursor:Landroid/database/Cursor;
    goto :goto_1
    ...
    .line 406
    invoke-direct/range {v17 .. v23}, Landroid/content/ContentResolver;->maybeLogQueryToEventLog(JLandroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local v18           #durationMillis:J
    .end local v25           #qCursor:Landroid/database/Cursor;
