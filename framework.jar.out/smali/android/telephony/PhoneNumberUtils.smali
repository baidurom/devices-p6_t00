...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/telephony/PhoneNumberUtils$MccNumberMatch;
    }
.end annotation
...
.field public static final TOA_AlphaNumeric:I = 0xd1
...
.method static constructor <clinit>()V
    ...
    .line 112
    invoke-static {}, Landroid/telephony/PhoneNumberUtils;->initMccMatchTable()Ljava/util/ArrayList;

    move-result-object v0

    sput-object v0, Landroid/telephony/PhoneNumberUtils;->table:Ljava/util/ArrayList;
...
.method public static convertPlusByMcc(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .prologue
    .line 191
    invoke-static {p1}, Landroid/telephony/PhoneNumberUtils;->getRecordByMcc(I)Landroid/telephony/PhoneNumberUtils$MccNumberMatch;

    move-result-object v1

    .line 192
    .local v1, record:Landroid/telephony/PhoneNumberUtils$MccNumberMatch;
    ...
    .restart local p0
    :cond_1
    invoke-virtual {v1}, Landroid/telephony/PhoneNumberUtils$MccNumberMatch;->getCc()Ljava/lang/String;
    ...
    .line 203
    .local v0, realNum:Ljava/lang/String;
    invoke-virtual {v1}, Landroid/telephony/PhoneNumberUtils$MccNumberMatch;->getSpcs()[Ljava/lang/String;

    move-result-object v3

    invoke-static {v0, v3}, Landroid/telephony/PhoneNumberUtils;->beginWith(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    .line 205
    invoke-virtual {v1}, Landroid/telephony/PhoneNumberUtils$MccNumberMatch;->getNdd()Ljava/lang/String;
...
.method private static findNextPCharOrNonPOrNonWCharIndex(Ljava/lang/String;I)I
    ...
    invoke-static {v4}, Landroid/telephony/PhoneNumberUtils;->isWait(C)Z
    ...
    .line 2788
    .local v0, cNext:C
    invoke-static {v0}, Landroid/telephony/PhoneNumberUtils;->isWait(C)Z
    ...
    invoke-static {v0}, Landroid/telephony/PhoneNumberUtils;->isPauseChar(C)Z
    ...
    invoke-static {v4}, Landroid/telephony/PhoneNumberUtils;->isPauseChar(C)Z
...
.method public static formatDialString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2862
    invoke-static {p0, v1}, Landroid/telephony/PhoneNumberUtils;->findNextPCharOrNonPOrNonWCharIndex(Ljava/lang/String;I)I
    ...
    .line 2865
    invoke-static {p0, v1, v3}, Landroid/telephony/PhoneNumberUtils;->findPOrWCharToAppend(Ljava/lang/String;II)C
...
.method private static getRecordByMcc(I)Landroid/telephony/PhoneNumberUtils$MccNumberMatch;
    .locals 2
    .parameter "mcc"
    ...
    .local v0, i:I
    :goto_0
    sget-object v1, Landroid/telephony/PhoneNumberUtils;->table:Ljava/util/ArrayList;
    ...
    check-cast v1, Landroid/telephony/PhoneNumberUtils$MccNumberMatch;

    invoke-virtual {v1}, Landroid/telephony/PhoneNumberUtils$MccNumberMatch;->getMcc()I
...
.method private static initMccMatchTable()Ljava/util/ArrayList;
    ...
    .line 171
    .local v6, tempTable:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/telephony/PhoneNumberUtils$MccNumberMatch;>;"
    new-instance v0, Landroid/telephony/PhoneNumberUtils$MccNumberMatch;
    ...
    const-string v5, "13,15,18"

    invoke-direct/range {v0 .. v5}, Landroid/telephony/PhoneNumberUtils$MccNumberMatch;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static isEmergencyNumberInternal(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 1874
    const-string/jumbo v10, "ro.config.dist_nosim_airplane"
...
.method private static isPauseChar(C)Z
    .locals 1
    .parameter "c"
...
.method public static numberToCalledPartyAlphaNumbericHelper(Ljava/lang/String;)[B
    .locals 1
    .parameter "number"
    ...
    invoke-static {p0, v0}, Landroid/telephony/PhoneNumberUtils;->numberToCalledPartyAlphaNumbericHelper(Ljava/lang/String;Z)[B
...
.method private static numberToCalledPartyAlphaNumbericHelper(Ljava/lang/String;Z)[B
    .locals 12
    .parameter "number"
    ...
    :try_start_0
    invoke-static {p0, v7, v8, v9, v10}, Lcom/android/internal/telephony/GsmAlphabet;->stringToGsm7BitPacked_Ex(Ljava/lang/String;IZII)[B
    :try_end_0
    ...
    .line 1276
    invoke-static {v4, v11, v6, v3, v5}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    const-string v9, "EncodeException"
