...
.field protected static final EVENT_CDMA_PRL_VERSION_CHANGED:I = 0x25

.field protected static final EVENT_CDMA_SUBSCRIPTION_SOURCE_CHANGED:I = 0x1e
...
.field protected static final EVENT_GET_MDN_DONE:I = 0x24

.field protected static final EVENT_GET_MMI_INIT:I = 0x64

.field protected static final EVENT_GET_NETWORKS_DONE:I = 0x1c

.field protected static final EVENT_GET_SIM_STATUS_DONE:I = 0xb

.field protected static final EVENT_ICC_CHANGED:I = 0x23

.field protected static final EVENT_ICC_RECORDS_EONS_UPDATED:I = 0x1b

.field protected static final EVENT_ICC_RECORD_EVENTS:I = 0x21

.field protected static final EVENT_IMS_STATE_CHANGED:I = 0x26

.field protected static final EVENT_IMS_STATE_DONE:I = 0x27
...
.field protected static final EVENT_SET_MODEM_POWER_DONE:I = 0x1d

.field protected static final EVENT_SET_NETWORK_AUTOMATIC:I = 0x1f
...
.field public static final NETWORK_SELECTION2_KEY:Ljava/lang/String; = "network_selection2_key"

.field public static final NETWORK_SELECTION2_NAME_KEY:Ljava/lang/String; = "network_selection2_name_key"

.field public static final NETWORK_SELECTION_KEY:Ljava/lang/String; = "network_selection_key"

.field public static final NETWORK_SELECTION_NAME_KEY:Ljava/lang/String; = "network_selection_name_key"

.field public static final NETWORK_SELECTION_OPERATOR_KEY:Ljava/lang/String; = "network_selection_operator_key"
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Z)V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mLock:Ljava/lang/Object;
...
.method private getSavedNetworkSelection()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/huawei/telephony/HuaweiTelephonyManager;->IsSlot2Gsm()Z
    ...
    .line 619
    :cond_2
    const-string v1, "network_selection_operator_key"
...
.method private notifyPending(Landroid/os/AsyncResult;)V
    ...
    .line 414
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mLock:Ljava/lang/Object;
...
.method private setPropertiesByCarrier()V
    ...
    invoke-static {v9, v7, v3, v11}, Lcom/android/internal/telephony/MccTable;->setSystemLocale(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    const-string v2, "Dial with uusInfo is not supported in this phone "
...
.method public getIccFileHandler()Lcom/android/internal/telephony/IccFileHandler;
    ...
    const-string v4, "mUiccApplication = null! sleep 1 sec"
    ...
    const-string v4, "Sleep Interruptted!"
    ...
    const-string v5, "getIccFileHandler mUiccApplication = "
    ...
    .line 812
    .local v2, uiccApplication:Lcom/android/internal/telephony/UiccCardApplication;
    if-nez v2, :cond_1
...
.method public getUiccApplication()Lcom/android/internal/telephony/UiccCardApplication;
    .locals 1
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mLock:Ljava/lang/Object;
    ...
    const-string v4, "handle EVENT_CALL_RING EVENT_SET_MODEM_POWER_DONE"

    invoke-static {v2, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 393
    :cond_4
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/PhoneBase;->notifyPending(Landroid/os/AsyncResult;)V
...
.method public invokeSimlessHW()V
    ...
    invoke-interface {v0, v1}, Lcom/android/internal/telephony/CommandsInterface;->invokeSimlessHW(Landroid/os/Message;)V
...
.method public registerForCdmaWaitingNumberChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .prologue
    .line 1517
    const-string v0, "registerForCdmaWaitingNumberChanged"
...
.method public restoreSavedNetworkSelection(Landroid/os/Message;)V
    ...
    invoke-virtual {v1}, Lcom/huawei/telephony/HuaweiTelephonyManager;->IgnoreManualSelectMode()Z
    ...
    const-string v2, "[GlobalModeManager]IgnoreManualSelectMode=true"
    ...
    const-string v2, "[GlobalModeManager]IgnoreManualSelectMode=false"
...
.method public setModemPower(Z)V
    ...
    invoke-interface {v2, p1, v0}, Lcom/android/internal/telephony/CommandsInterface;->setModemPower(ZLandroid/os/Message;)V

    .line 1503
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/PhoneBase;->waitForResult(Ljava/util/concurrent/atomic/AtomicBoolean;)V
...
.method public setPowerGrade(ILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->setPowerGrade(ILandroid/os/Message;)V
...
.method public setState(Lcom/android/internal/telephony/PhoneConstants$State;)V
    ...
    const-string v1, "setState unsupported for this phone"
...
.method public unregisterForCdmaWaitingNumberChanged(Landroid/os/Handler;)V
    ...
    .prologue
    .line 1524
    const-string v0, "unregisterForCdmaWaitingNumberChanged"
...
.method protected waitForResult(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    const-string v2, "interrupted while trying to waitForResult"
