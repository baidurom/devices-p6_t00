...
.field static final MAX_END_CALL_DURATION:I = 0x7530
...
.field cdmaWaitingNumberChangedRegistrants:Landroid/os/RegistrantList;
...
.method public constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->cdmaWaitingNumberChangedRegistrants:Landroid/os/RegistrantList;
    ...
    .line 86
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->hangupPendingMO:Z
...
.method private handleCallWaitingInfo(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V
    ...
    const-string v3, "the ringingcall connection size = "
    ...
    .line 1088
    .local v0, cc:Lcom/android/internal/telephony/cdma/CdmaConnection;
    invoke-virtual {v0, p1}, Lcom/android/internal/telephony/cdma/CdmaConnection;->isNewConnection(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)Z
    ...
    const-string v2, "Update the ringing connection if the call is from another number."

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 1090
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->notifyWaitingNumberChanged()V
    ...
    .line 1104
    .end local v0           #cc:Lcom/android/internal/telephony/cdma/CdmaConnection;
    :cond_1
    :goto_0
    ...
    invoke-virtual {v1, v2}, Lcom/android/internal/telephony/cdma/CdmaCall;->isTooFrequency(Ljava/lang/String;)Z
    ...
    const-string v2, "ringing too frequency, ignore this callwaiting message."
    ...
    const-string v2, "new callwaiting message, create a connection"
...
.method private handleLineControlInfo(Lcom/android/internal/telephony/cdma/CdmaInformationRecords$CdmaLineControlInfoRec;)V
    ...
    .prologue
    .line 1120
    iget-byte v1, p1, Lcom/android/internal/telephony/cdma/CdmaInformationRecords$CdmaLineControlInfoRec;->lineCtrlPolarityIncluded:B
    ...
    .line 1124
    .local v0, fgConn:Lcom/android/internal/telephony/cdma/CdmaConnection;
    if-eqz v0, :cond_0
    ...
    .line 1126
    invoke-virtual {v0}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onLineControlInfo()V

    .line 1128
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->notifyLineControlInfo()V

    .line 1134
    .end local v0           #fgConn:Lcom/android/internal/telephony/cdma/CdmaConnection;
    :cond_0
    :goto_0
    return-void
...
.method private notifyWaitingNumberChanged()V
    .locals 3
    ...
    const-string v1, "notifyWaitingNumberChanged"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 1066
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->cdmaWaitingNumberChangedRegistrants:Landroid/os/RegistrantList;
...
.method acceptCall()V
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/cdma/CdmaConnection;->address:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/android/internal/telephony/cdma/CdmaCall;->setLastRingNumberAndChangeTime(Ljava/lang/String;)V
...
.method public cleanRilRecovery(Lcom/android/internal/telephony/Connection;)V
    .locals 1
    .parameter "cn"
...
.method public dispose()V
    ...
    const-string v6, "CdmaCallTracker unregisterForLineControlInfo!"
...
.method getConnectionByIndex(Lcom/android/internal/telephony/cdma/CdmaCall;I)Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getIndex()I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v6, "EVENT_CALL_LINE_CONTROL_INFO Received"
    ...
    const-string v6, "EVENT_CALL_LINE_CONTROL_INFO Received but there is some exception!"
    ...
    invoke-interface {v5, v7}, Lcom/android/internal/telephony/CommandsInterface;->restartRild(Landroid/os/Message;)V
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    const-string v19, ">handlePollCalls"
...
.method hangup(Lcom/android/internal/telephony/cdma/CdmaCall;)V
    ...
    .line 930
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->hasMessages(I)Z
    ...
    invoke-virtual {p0, v0, v3, v4}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method hangup(Lcom/android/internal/telephony/cdma/CdmaConnection;)V
    ...
    .line 880
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->hasMessages(I)Z
    ...
    invoke-virtual {p1}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getIndex()I
...
.method public registerForCdmaWaitingNumberChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 3
    .parameter "h"
    .parameter "what"
    .parameter "obj"
    ...
    const-string v2, "registerForCdmaWaitingNumberChanged!"
    ...
    .line 210
    .local v0, r:Landroid/os/Registrant;
    iget-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->cdmaWaitingNumberChangedRegistrants:Landroid/os/RegistrantList;
...
.method public unregisterForCdmaWaitingNumberChanged(Landroid/os/Handler;)V
    .locals 2
    .parameter "h"
    ...
    const-string v1, "unregisterForCdmaWaitingNumberChanged!"
