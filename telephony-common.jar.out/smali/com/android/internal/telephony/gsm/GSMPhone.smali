...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;Z)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-interface {v0, p0, v1, v3}, Lcom/android/internal/telephony/CommandsInterface;->setOnSS(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private handleSetSelectNetwork(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v3}, Lcom/huawei/telephony/HuaweiTelephonyManager;->IsSlot2Gsm()Z
    ...
    const-string v5, "[GlobalModeManager]handleSetSelectNetwork IsSlot2Gsm=true,nsm.operatorNumeric="
    ...
    const-string v5, "nsm.operatorAlphaLong="
    ...
    const-string v5, "[GlobalModeManager]handleSetSelectNetwork IsSlot2Gsm=false,nsm.operatorNumeric="
...
.method private updateCallForwardStatus(I)V
    ...
    .line 1369
    .restart local v1       #r:Lcom/android/internal/telephony/IccRecords;
    :cond_1
    const/16 v2, 0x4b
...
.method public cancelAllPendingUssd()V
    .locals 3
    ...
    .line 2114
    .local v0, cursor_mmi:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    const/4 v1, 0x0
    ...
    .end local v0           #cursor_mmi:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    check-cast v0, Lcom/android/internal/telephony/gsm/GsmMmiCode;

    .line 2116
    .restart local v0       #cursor_mmi:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->isPendingUSSD()Z
    ...
    iput-object v2, v0, Lcom/android/internal/telephony/gsm/GsmMmiCode;->state:Lcom/android/internal/telephony/MmiCode$State;
...
.method public closeRrc()V
    ...
    const-string v3, "closeRrc in GSMPhone"
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    check-cast v4, Lcom/android/internal/telephony/UiccCardApplication;

    invoke-static {v2, p0, v4}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->newFromDialString(Ljava/lang/String;Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/UiccCardApplication;)Lcom/android/internal/telephony/gsm/GsmMmiCode;
    ...
    invoke-virtual {p0, v4, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public getCallForwardingIndicator()Z
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/IccRecords;->getVoiceCallForwardingFlag()Z
...
.method public getNeighboringCids(Landroid/os/Message;)V
    ...
    invoke-interface {v2, p1}, Lcom/android/internal/telephony/CommandsInterface;->getNeighboringCids(Landroid/os/Message;)V
...
.method protected getUiccCardApplication()Lcom/android/internal/telephony/UiccCardApplication;
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCardApplication(I)Lcom/android/internal/telephony/UiccCardApplication;
...
.method public getUimid()Ljava/lang/String;
    ...
    const-string v1, "[GSMPhone] getUimid() is a CDMA method"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    check-cast v13, Lcom/android/internal/telephony/IccRecords;

    .line 1449
    .local v13, r:Lcom/android/internal/telephony/IccRecords;
    move-object/from16 v0, p0
    ...
    .line 1461
    const-string v17, "ro.config.hw_ReduceSAR"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 1463
    .local v16, wifiHotState:I
    new-instance v17, Ljava/lang/StringBuilder;

    invoke-direct/range {v17 .. v17}, Ljava/lang/StringBuilder;-><init>()V

    const-string v18, "Radio available, set wifiHotState  "
    ...
    invoke-interface/range {v17 .. v19}, Lcom/android/internal/telephony/CommandsInterface;->setPowerGrade(ILandroid/os/Message;)V
    ...
    .line 1474
    .end local v16           #wifiHotState:I
    :sswitch_2
    const-string v17, "ro.config.multimode_cdma"
    ...
    invoke-interface/range {v17 .. v18}, Lcom/android/internal/telephony/CommandsInterface;->getCDMASubscription(Landroid/os/Message;)V
    ...
    .line 1496
    :cond_3
    const-string v17, "ro.config.hw_globalEcc"
    ...
    const-string v18, "GECC-EVENT_SIM_RECORDS_LOADED!!!!"
    ...
    .line 1499
    .local v6, hlpmn:Ljava/lang/String;
    const-string v17, ""
    ...
    const-string v18, "GECC-received EVENT_SIM_RECORDS_LOADED but not hplmn !!!!"
    ...
    invoke-virtual {v0, v6}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->globalEccCustom(Ljava/lang/String;)V

    goto/16 :goto_0

    .line 1509
    .end local v6           #hlpmn:Ljava/lang/String;
    ...
    const-string v19, "EVENT_ICC_RECORDS_EONS_UPDATED exception "
    ...
    const-string v19, "got EVENT_GET_IMEI_DONE , imei="
    ...
    const-string v19, "com.android.huawei.DM.IMEI_READY"
    ...
    .line 1561
    .local v15, ussdResult:[Ljava/lang/String;
    array-length v0, v15
    ...
    .end local v15           #ussdResult:[Ljava/lang/String;
    :sswitch_a
    move-object/from16 v0, p0
    ...
    invoke-virtual {v13, v0, v1}, Lcom/android/internal/telephony/IccRecords;->setVoiceCallForwardingFlag(IZ)V
    ...
    .line 1606
    .restart local v3       #ar:Landroid/os/AsyncResult;
    const-class v17, Lcom/android/internal/telephony/IccVmNotSupportedException;
    ...
    const-string v18, "Stop duplicate SET_NETWORK_SELECTION_AUTOMATIC to Ril "
    ...
    .line 1660
    .local v14, tmpMsg:Landroid/os/Message;
    const/16 v17, 0x3e9
    ...
    invoke-virtual {v0, v14, v1, v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->sendMessageDelayed(Landroid/os/Message;J)Z

    goto/16 :goto_0

    .line 1671
    .end local v14           #tmpMsg:Landroid/os/Message;
    :sswitch_12
    move-object/from16 v0, p1
    ...
    .line 1693
    .local v10, mymmi:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    move-object/from16 v0, p0
    ...
    .line 1699
    .end local v10           #mymmi:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    :sswitch_15
    const/4 v5, 0x0

    .line 1701
    .local v5, eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    move-object/from16 v0, p1
    ...
    invoke-virtual {v13, v0}, Lcom/android/internal/telephony/IccRecords;->getEonsForAvailableNetworks(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    const-string v18, "[EONS] Populated EONS names for available networks."
    ...
    invoke-static {v12, v5, v0}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    .end local v5           #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    check-cast v5, Ljava/util/ArrayList;

    .restart local v5       #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    goto :goto_3
    ...
    const-string v18, "[EONS] In EVENT_GET_NETWORKS_DONE, onComplete is null!"
...
.method public hasOtherPendingUssd(Lcom/android/internal/telephony/gsm/GsmMmiCode;)Z
    .locals 3
    .parameter "mmi"
...
.method public isMmiCode(Ljava/lang/String;)Z
    ...
    invoke-static {p1, p0, v3}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->newFromDialString(Ljava/lang/String;Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/UiccCardApplication;)Lcom/android/internal/telephony/gsm/GsmMmiCode;
...
.method protected onUpdateIccAvailability()V
    ...
    invoke-virtual {v2, v3}, Lcom/android/internal/telephony/gsm/SimPhoneBookInterfaceManager;->updateIccRecords(Lcom/android/internal/telephony/IccRecords;)V
...
.method public setCallBarringOption(ZLjava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v1, "setting call barring"
...
.method public setCallForwardingOption(IILjava/lang/String;ILandroid/os/Message;)V
    ...
    .line 1147
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getMcc()Ljava/lang/String;
    ...
    invoke-static {p3, v0}, Landroid/telephony/PhoneNumberUtils;->convertPlusByMcc(Ljava/lang/String;I)Ljava/lang/String;
...
.method public setRadioPower(Z)V
    ...
    const-string v1, "[GlobalModeManager]GSM setRadioPower="
    ...
    invoke-virtual {v0, p1}, Lcom/huawei/telephony/HuaweiTelephonyManager;->PowerOnGsmModem(Z)V
