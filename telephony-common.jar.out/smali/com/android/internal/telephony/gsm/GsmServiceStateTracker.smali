...
.field private static final PROPERTY_GLOBAL_FORCE_TO_SET_ECC:Ljava/lang/String; = "ril.force_to_set_ecc"
...
.field static final Tvalue:Ljava/lang/String; = "T"
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->SUPPORT_ROAMING_APNS:Z
...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 253
    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsCMCC:Z
    ...
    invoke-interface {v5, p0, v9, v7}, Lcom/android/internal/telephony/CommandsInterface;->registerForVoiceNetworkStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 316
    iget-object v5, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->cm:Lcom/android/internal/telephony/CommandsInterface;

    invoke-interface {v5, p0, v9, v7}, Lcom/android/internal/telephony/CommandsInterface;->registerForDataNetworkStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 318
    iget-object v5, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->cm:Lcom/android/internal/telephony/CommandsInterface;

    invoke-interface {v5, p0, v9, v7}, Lcom/android/internal/telephony/CommandsInterface;->registerForDataCallListChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private getCardType(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    .locals 2
    .parameter "phone"
    ...
    const-string v1, "Cardtype is usim"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 399
    const-string v0, "gsm.isusim"
    ...
    const-string v1, "Cardtype is sim"
...
.method private onSignalStrengthResult(Landroid/os/AsyncResult;)V
    ...
    .line 1798
    .local v4, wcdma_rscp:I
    const/4 v5, -0x1

    .line 1799
    .local v5, wcdma_ecio:I
    ...
    invoke-direct/range {v1 .. v16}, Landroid/telephony/SignalStrength;-><init>(IIIIIIIIIIIIIIZ)V
    ...
    const-string v3, "onSignalStrengthResult() rssi = "
...
.method private pollStateDone()V
    ...
    .line 1327
    .local v20, hasRadioTechnologyChanged:Z
    :goto_4
    move-object/from16 v0, p0
    ...
    const-string v39, "ServiceState changed, update operator name display"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mRatChangedRegistrants:Landroid/os/RegistrantList;
    ...
    const-string v40, "in GSM servicestatetracker, roaming:"
    ...
    const-string v39, "ro.config.hw_opta"

    const/16 v40, 0x0

    invoke-static/range {v39 .. v40}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I
    ...
    const-string v39, "ro.config.hw_optb"
    ...
    invoke-virtual/range {v38 .. v38}, Lcom/huawei/telephony/HuaweiTelephonyManager;->getDualCardMode()I

    move-result v12

    .line 1606
    .local v12, dualCardMode:I
    invoke-static {}, Lcom/huawei/telephony/HuaweiTelephonyManager;->getDefault()Lcom/huawei/telephony/HuaweiTelephonyManager;
    ...
    invoke-virtual {v0, v12}, Lcom/huawei/telephony/HuaweiTelephonyManager;->cdmaCardInGsmMode(I)Z

    move-result v7

    .line 1607
    .local v7, cdmaCardInGsmMode:Z
    if-eqz v7, :cond_d

    .line 1609
    const-string v38, "gsm.hw.matchnum"
    ...
    .line 1614
    .end local v7           #cdmaCardInGsmMode:Z
    .end local v12           #dualCardMode:I
    :cond_d
    if-eqz v23, :cond_f
    ...
    const-string v39, "LAC changed, update operator name display"
    ...
    .end local v18           #hasLacChanged:Z
    .end local v19           #hasLocationChanged:Z
    .end local v20           #hasRadioTechnologyChanged:Z
    ...
    .line 1327
    .restart local v20       #hasRadioTechnologyChanged:Z
    :cond_19
    const/4 v14, 0x0
    ...
    .line 1437
    .restart local v18       #hasLacChanged:Z
    ...
    const-string v39, "pollStateDone: adj l="
    ...
    const-string v40, "NITZ: pollStateDone to get zone infor, zone = "
...
.method private sendBroadcastRadioState()V
    ...
    .prologue
    .line 409
    const-string v1, "GSM sendBroadcastRadioState"
...
.method private sendNitzSlctBcs(Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    .parameter "operator"
    .parameter "iso"
    ...
    const-string v1, "android.intent.action.ACTION_TIMEZONE_SELECTION"
...
.method private sendTimeZoneSelectionNotification()V
    ...
    iget-boolean v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mNitzUpdatedTime:Z
    ...
    .line 1670
    .local v4, timeZones:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/util/TimeZone;>;"
    const/4 v6, 0x0

    .line 1672
    .local v6, tzListSize:I
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "[settimezone] the network "
    ...
    const-string v9, " don\'t support nitz!"
    ...
    .line 1676
    invoke-static {v0}, Landroid/util/TimeUtils;->getTimeZones(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    const-string v9, "[settimezone]There are "
    ...
    const-string v9, ", set the time zone manual!"
    ...
    .line 1683
    invoke-direct {p0, v3, v0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->sendNitzSlctBcs(Ljava/lang/String;Ljava/lang/String;)V

    .line 1712
    .end local v0           #iso:Ljava/lang/String;
    .end local v4           #timeZones:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/util/TimeZone;>;"
    .end local v6           #tzListSize:I
    :cond_0
    :goto_1
    if-eqz v3, :cond_1
    ...
    const-string v8, "last_registed_mcc"

    invoke-static {v7, v8, v2}, Landroid/provider/SettingsEx$Systemex;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .restart local v4       #timeZones:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/util/TimeZone;>;"
    .restart local v6       #tzListSize:I
    :cond_2
    ...
    const-string v9, "last_registed_mcc"

    invoke-static {v8, v9}, Landroid/provider/SettingsEx$Systemex;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v9, "[settimezone]Only one time zone in "
    ...
    const-string v9, ", update the system time to the local time!"
    ...
    const-string v9, "[settimezone] time zone:"
    ...
    .line 1702
    .end local v1           #lastMcc:Ljava/lang/String;
    ...
    const-string v9, "[settimezone]can\'t find a timezone for "
    ...
    invoke-direct {p0, v3, v8}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->sendNitzSlctBcs(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_1

    .line 1706
    :cond_6
    const-string v8, "[settimezone] no iso country found, set the time manual!"
...
.method private setTimeFromNITZString(Ljava/lang/String;J)V
    ...
    const-string v27, "NITZ: setTimeFromNITZString, zone= "
...
.method private trySwitchApns(I)V
    ...
    const-string v9, "trySwitchApns, dualCardMode:"
    ...
    const-string v9, " cdmaCardInGsmMode: "
    ...
    invoke-virtual {v7, v5}, Lcom/huawei/telephony/HuaweiTelephonyManager;->isCardPresent(I)Z
    ...
    invoke-virtual {v7}, Lcom/huawei/telephony/HuaweiTelephonyManager;->isGsmImsiContainsSpecPlmn()Z
    ...
    const-string v6, "Simcard2 reported the roaming state , ignore the message  and do not change the APN"
    ...
    :cond_4
    const-string v7, "persist.radio.roaming_mode"
    ...
    .line 2753
    .local v3, originApnRoamingMode:I
    move v2, p1

    .line 2755
    .local v2, newApnRoamingMode:I
    const-string v5, "GSM"
    ...
    const-string v8, "trySwitchApns, originApnRoamingMode:"
    ...
    const-string v8, " newApnRoamingMode: "
    ...
    const-string v6, "restore roaming APNs for GSM in dual mode"

    invoke-static {v5, v6}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2762
    const-string v5, "persist.radio.roaming_mode"
    ...
    .line 2763
    sget-object v5, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->URL_RESTOREAPN_FOR_ROAMING:Landroid/net/Uri;
    ...
    const-string v6, "restore no roaming APNs for GSM in dual mode"
    ...
    .line 2767
    sget-object v5, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->URL_RESTOREAPN_FOR_NO_ROAMING:Landroid/net/Uri;
...
.method public globalEccCustom(Ljava/lang/String;)V
    ...
    .line 2473
    .local v10, forceEccState:Ljava/lang/String;
    const-string v0, "ril.force_to_set_ecc"
    ...
    const-string v1, "GECC-globalEccCustom: operator numeric = "
    ...
    .line 2493
    const-string v0, "GECC-globalEccCustom: No matched emergency numbers in db."
    ...
    const-string v1, "GECC-globalEccCustom: ecc_withcard = "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 444
    const-string v13, "ro.config.hw_dsda"
    ...
    invoke-virtual {v13}, Landroid/telephony/TelephonyManager;->isMultiSimEnabled()Z
    ...
    .line 445
    const-string v13, "[GlobalModeManager]EVENT_SIM_READY for Slot2"
    ...
    .line 446
    const-string v13, "ro.config.hw_globalmode"
    ...
    invoke-virtual {v13}, Lcom/huawei/telephony/HuaweiTelephonyManager;->SetGsmCardTypeReady()V

    .line 453
    :cond_2
    const-string v13, "ro.config.hw_disable_cops"
    ...
    .line 456
    :cond_4
    const-string v13, "[GlobalModeManager]ro.config.hw_disable_cops is true"
    ...
    .line 471
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->sendBroadcastRadioState()V
    ...
    .line 480
    const-string v13, "GECC-NW PLMN change!!!!"
    ...
    .end local v1           #ar:Landroid/os/AsyncResult;
    :sswitch_b
    const-string v13, "DelayUpdateSignalStregth -EVENT_DELAY_UPDATE_GSM_SIGNAL_STRENGTH Timeout notifySignalStrength"
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->cancelSignalStrengthDelayTimer(I)V
    ...
    invoke-virtual {v13}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifySignalStrength()V

    .line 574
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mSignalStrength:Landroid/telephony/SignalStrength;

    move-object/from16 v0, p0

    iput-object v13, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->tempSignalStrength:Landroid/telephony/SignalStrength;
    ...
    iput-boolean v13, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isStroredSignalStrength:Z
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->trySwitchApns(I)V

    goto/16 :goto_0

    .line 659
    :sswitch_15
    const-string v13, "[settimezone]EVENT_NITZ_CAPABILITY_NOTIFICATION"
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    check-cast v25, Lcom/android/internal/telephony/CommandException;

    check-cast v25, Lcom/android/internal/telephony/CommandException;

    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/CommandException;->getCommandError()Lcom/android/internal/telephony/CommandException$Error;

    move-result-object v5

    .line 973
    :cond_2
    sget-object v25, Lcom/android/internal/telephony/CommandException$Error;->RADIO_NOT_AVAILABLE:Lcom/android/internal/telephony/CommandException$Error;
    ...
    .line 985
    :cond_4
    sget-object v25, Lcom/android/internal/telephony/CommandException$Error;->OP_NOT_ALLOWED_BEFORE_REG_NW:Lcom/android/internal/telephony/CommandException$Error;
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->checkForRoamingForIndianOperators(Landroid/telephony/ServiceState;)Z
    ...
    .line 1143
    .local v16, regplmn:Ljava/lang/String;
    const/16 v20, 0x0

    .line 1144
    .local v20, regplmnCustomString:Ljava/lang/String;
    const/16 v18, 0x0

    .line 1145
    .local v18, regplmnCustomArray:[Ljava/lang/String;
    const/16 v17, 0x0

    .line 1146
    .local v17, regplmnCustomArrEleBuf:[Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/IccRecords;->getOperatorNumeric()Ljava/lang/String;

    move-result-object v7

    .line 1148
    const-string v25, "GsmServiceStateTracker"

    new-instance v26, Ljava/lang/StringBuilder;

    invoke-direct/range {v26 .. v26}, Ljava/lang/StringBuilder;-><init>()V

    const-string v27, "handlePollStateResult hplmn = "
    ...
    const-string v27, "handlePollStateResult regplmn = "
    ...
    const-string v26, "reg_plmn_custom"

    invoke-static/range {v25 .. v26}, Landroid/provider/SettingsEx$Systemex;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v27, "handlePollStateResult plmnCustomString = "
    ...
    .line 1170
    .local v19, regplmnCustomArrayLen:I
    const/4 v8, 0x0
    ...
    const-string v27, "regplmnCustomArray["
    ...
    const-string v27, "handlePollStateResult roaming = "
    ...
    .line 1185
    .end local v8           #i:I
    .end local v19           #regplmnCustomArrayLen:I
    :cond_b
    move-object/from16 v0, p0
    ...
    .line 1187
    sget-boolean v25, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->SUPPORT_ROAMING_APNS:Z
    ...
    invoke-virtual {v0, v11}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->sendMessage(Landroid/os/Message;)Z
    ...
    invoke-virtual/range {v25 .. v26}, Landroid/telephony/ServiceState;->setEmergencyOnly(Z)V
    ...
    .end local v16           #regplmn:Ljava/lang/String;
    .end local v17           #regplmnCustomArrEleBuf:[Ljava/lang/String;
    .end local v18           #regplmnCustomArray:[Ljava/lang/String;
    .end local v20           #regplmnCustomString:Ljava/lang/String;
    .end local v21           #roaming:Z
    .end local v24           #voice_capable:Z
    :cond_d
    ...
    const-string v26, "Exception while polling service state. Probably malformed RIL response."
    ...
    const-string v27, "[EONS] Received TAC = "
    ...
    const-string v27, "[EONS] EVENT_POLL_STATE_GPRS newGPRSState ="
    ...
    const-string v27, " , mDataRadioTechnology ="
    ...
    const-string v26, "error parsing GprsRegistrationState: "
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsCMCC:Z
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GSMPhone;->isManualNetSelAllowed()Z
    ...
    const-string v26, " Forcing Automatic Network Selection, manual selection is not allowed"
    ...
    .line 1128
    .end local v9           #ints:[I
    .restart local v24       #voice_capable:Z
    :cond_1a
    const/16 v21, 0x0
    ...
    .restart local v16       #regplmn:Ljava/lang/String;
    .restart local v17       #regplmnCustomArrEleBuf:[Ljava/lang/String;
    .restart local v18       #regplmnCustomArray:[Ljava/lang/String;
    .restart local v20       #regplmnCustomString:Ljava/lang/String;
    :cond_1c
    const/16 v21, 0x0
    ...
    const-string v26, "Exception when got name value"
    ...
    .restart local v19       #regplmnCustomArrayLen:I
    :cond_1d
    const/16 v17, 0x0
...
.method protected hangupAndPowerOff()V
    ...
    .line 707
    const-string v0, "[GlobalModeManager]GSM hangupAndPowerOff"
    ...
    invoke-virtual {v0, v2}, Lcom/huawei/telephony/HuaweiTelephonyManager;->PowerOnGsmModem(Z)V
...
.method protected onUpdateIccAvailability()V
    ...
    .line 2549
    iput-object v4, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mUiccApplcation:Lcom/android/internal/telephony/UiccCardApplication;
    ...
    invoke-virtual {v1, p0, v2, v4}, Lcom/android/internal/telephony/IccRecords;->registerForRecordsEvents(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method protected setPowerStateToDesired()V
    ...
    .line 681
    const-string v1, "[GlobalModeManager]GSM setPowerStateToDesired ON"
    ...
    invoke-virtual {v1, v4}, Lcom/huawei/telephony/HuaweiTelephonyManager;->PowerOnGsmModem(Z)V
    ...
    :cond_3
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isInShutDown()Z
...
.method public toGetRplmnsThenSendEccNum()V
    ...
    .line 2441
    .local v2, rplmns:Ljava/lang/String;
    ...
    .line 2444
    .local v0, forceEccState:Ljava/lang/String;
    const-string v3, "ril.force_to_set_ecc"
    ...
    const-string v4, "GECC-toGetRplmnsThenSendEccNum: hplmn = "
    ...
    invoke-interface {v3}, Lcom/android/internal/telephony/IccCard;->getIccCardStateHW()Z
    ...
    .line 2454
    :cond_0
    const-string v3, "ril.operator.numeric"
    ...
    .line 2456
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->globalEccCustom(Ljava/lang/String;)V
...
.method public updateEons()V
    ...
    invoke-virtual {v3, v4, v1}, Lcom/android/internal/telephony/IccRecords;->updateEons(Ljava/lang/String;I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected updateSpnDisplay()V
    ...
    invoke-virtual {v14, v0}, Lcom/android/internal/telephony/IccRecords;->getDisplayRule(Ljava/lang/String;)I

    move-result v16

    .line 780
    invoke-virtual {v14}, Lcom/android/internal/telephony/IccRecords;->getServiceProviderName()Ljava/lang/String;
    ...
    iget-object v0, v14, Lcom/android/internal/telephony/IccRecords;->mEons:Lcom/android/internal/telephony/gsm/EONS;

    move-object/from16 v20, v0

    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/telephony/gsm/EONS;->isEonsDisabled()Z
    ...
    const-string v21, "updateSpnDisplay():get plmn from SIM card! "

    invoke-static/range {v20 .. v21}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 787
    invoke-virtual {v14}, Lcom/android/internal/telephony/IccRecords;->getEons()Ljava/lang/String;
    ...
    const-string v21, "updateSpnDisplay(): get plmn from network!"
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsCMCC:Z
    ...
    invoke-static/range {v20 .. v21}, Landroid/provider/SettingsEx$Systemex;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 811
    :goto_1
    new-instance v20, Lcom/android/internal/telephony/PlmnConstants;

    move-object/from16 v0, v20

    invoke-direct {v0, v4}, Lcom/android/internal/telephony/PlmnConstants;-><init>(Ljava/lang/String;)V

    move-object/from16 v0, v20

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->plmnConstants:Lcom/android/internal/telephony/PlmnConstants;
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->plmnConstants:Lcom/android/internal/telephony/PlmnConstants;

    move-object/from16 v20, v0

    move-object/from16 v0, v20

    invoke-virtual {v0, v11, v10}, Lcom/android/internal/telephony/PlmnConstants;->getPlmnValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v13

    .line 815
    .local v13, plmnValue:Ljava/lang/String;
    const-string v20, "ro.config.addAct"
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->getCardType(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 866
    .local v2, cpm:Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;
    invoke-virtual {v14}, Lcom/android/internal/telephony/IccRecords;->getOperatorNumeric()Ljava/lang/String;

    move-result-object v6

    .line 867
    .local v6, hplmn:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 869
    .local v3, custSpn:Ljava/lang/String;
    const-string v20, "GSM"
    ...
    .line 870
    invoke-virtual {v2, v6, v15, v3}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->acquireFromCust(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 871
    iget-boolean v0, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->showSpn:Z

    move/from16 v18, v0

    .line 872
    iget-boolean v0, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->showPlmn:Z

    move/from16 v17, v0

    .line 873
    iget v0, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->rule:I

    move/from16 v16, v0

    .line 874
    iget-object v12, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->plmn:Ljava/lang/String;

    .line 875
    iget-object v0, v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;->spn:Ljava/lang/String;
    ...
    .line 881
    .end local v2           #cpm:Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$CustPlmnMember;
    .end local v3           #custSpn:Ljava/lang/String;
    .end local v6           #hplmn:Ljava/lang/String;
    .end local v15           #regplmn:Ljava/lang/String;
    :cond_a
    const-string v20, "ro.config.notshowSpn"
    ...
    const-string v20, "ro.config.hw_dsda"
    ...
    const-string v21, "china operator, just show plmn no spn"
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/telephony/TelephonyManager;->isMultiSimEnabled()Z
    ...
    .line 903
    const-string v20, "Send Intent for SUB1: android.intent.action.ACTION_DSDS_SUB1_OPERATOR_CHANGED"
    ...
    const-string v20, "android.intent.action.ACTION_DSDS_SUB1_OPERATOR_CHANGED"
    ...
    .end local v13           #plmnValue:Ljava/lang/String;
    .end local v17           #showPlmn:Z
    .end local v18           #showSpn:Z
    :cond_d
    const-string v20, "GSM"

    const-string v21, "mIccRecords null while updateSpnDisplay was called."
    ...
    const-string v21, "Exception when got data value"
    ...
    .restart local v10       #languageCode:Ljava/lang/String;
    .restart local v13       #plmnValue:Ljava/lang/String;
    :cond_e
    move-object/from16 v0, p0
    ...
    .line 913
    const-string v20, "Send Intent for SUB2: android.intent.action.ACTION_DSDS_SUB2_OPERATOR_CHANGED"
    ...
    const-string v20, "android.intent.action.ACTION_DSDS_SUB2_OPERATOR_CHANGED"
    ...
    const-string v21, "unsupport SUB ID: "
