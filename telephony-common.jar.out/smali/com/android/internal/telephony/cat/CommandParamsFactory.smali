...
.field static final HAVE_CONFIRM_AND_CALL:I = 0x3
...
.field static final NO_CONFIRM_OR_CALL:I = 0x0

.field static final ONLY_HAVE_CALL:I = 0x2

.field static final ONLY_HAVE_CONFIRM:I = 0x1
...
.field private static markForAlpha:I
...
.method static constructor <clinit>()V
    ...
    new-array v0, v0, [Lcom/android/internal/telephony/cat/CommandParamsFactory;
    ...
    sput v0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->markForAlpha:I

    return-void
.end method

.method private constructor <init>(Lcom/android/internal/telephony/cat/RilMessageDecoder;I)V
    .locals 2
    .parameter "caller"
    .parameter "slotId"
    ...
    .line 94
    iput p2, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mSlotId:I
    ...
    const-string v1, "create CommandParamsFactory "
...
.method static declared-synchronized getInstance(Lcom/android/internal/telephony/cat/RilMessageDecoder;I)Lcom/android/internal/telephony/cat/CommandParamsFactory;
    .locals 3
    .parameter "caller"
    .parameter "slotId"
    ...
    new-instance v2, Lcom/android/internal/telephony/cat/CommandParamsFactory;

    invoke-direct {v2, p0, p1}, Lcom/android/internal/telephony/cat/CommandParamsFactory;-><init>(Lcom/android/internal/telephony/cat/RilMessageDecoder;I)V
...
.method private processLanguageNotification(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    const-string v4, "commandQualifier = "
    ...
    .line 971
    const-string v2, "commandQualifier 0x00"
    ...
    invoke-direct {v2, p1, v0}, Lcom/android/internal/telephony/cat/LanguageNotificationParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/lang/String;)V
    ...
    .line 975
    :pswitch_0
    const-string v2, "commandQualifier 0x01"
...
.method private processSetupCall(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    invoke-direct {p0, v8, v9, v6}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->searchForAddressTag(Lcom/android/internal/telephony/cat/ComprehensionTlvTag;Lcom/android/internal/telephony/cat/ComprehensionTlvTag;Ljava/util/Iterator;)Lcom/android/internal/telephony/cat/ComprehensionTlv;
    ...
    .line 1089
    invoke-static {v5}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveAddr(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Ljava/lang/String;
    ...
    const-string v9, "markForAlpha value: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    sget v9, Lcom/android/internal/telephony/cat/CommandParamsFactory;->markForAlpha:I
    ...
    .line 1093
    sget v8, Lcom/android/internal/telephony/cat/CommandParamsFactory;->markForAlpha:I
    ...
    const-string v9, "confirmMsg.txt: "
    ...
    const-string v9, "callMsg.txt: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, v1, Lcom/android/internal/telephony/cat/TextMessage;->text:Ljava/lang/String;
    ...
    invoke-direct {v8, p1, v4, v1, v2}, Lcom/android/internal/telephony/cat/CallSetupParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/TextMessage;Lcom/android/internal/telephony/cat/TextMessage;Ljava/lang/String;)V
    ...
    iget v8, v3, Lcom/android/internal/telephony/cat/IconId;->recordNumber:I
    ...
    iput-boolean v8, v4, Lcom/android/internal/telephony/cat/TextMessage;->iconSelfExplanatory:Z
...
.method private searchForAddressTag(Lcom/android/internal/telephony/cat/ComprehensionTlvTag;Lcom/android/internal/telephony/cat/ComprehensionTlvTag;Ljava/util/Iterator;)Lcom/android/internal/telephony/cat/ComprehensionTlv;
    .locals 8
    .parameter "tagAlpha"
    .parameter "tagAddress"
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .local p3, iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    const/4 v7, 0x1
    ...
    .line 330
    .local v4, tagAlphaValue:I
    invoke-virtual {p2}, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->value()I

    move-result v3

    .line 331
    .local v3, tagAddressValue:I
    const/4 v6, 0x0

    sput v6, Lcom/android/internal/telephony/cat/CommandParamsFactory;->markForAlpha:I

    .line 332
    const/4 v2, 0x0

    .line 333
    .local v2, findConfirmAlpha:Z
    const/4 v1, 0x0

    .line 334
    .local v1, findAddress:Z
    const/4 v5, 0x0

    .line 336
    .local v5, tempCtlv:Lcom/android/internal/telephony/cat/ComprehensionTlv;
    :cond_0
    :goto_0
    ...
    .line 342
    sput v7, Lcom/android/internal/telephony/cat/CommandParamsFactory;->markForAlpha:I
    ...
    .line 360
    .end local v5           #tempCtlv:Lcom/android/internal/telephony/cat/ComprehensionTlv;
    :goto_2
    return-object v5

    .restart local v5       #tempCtlv:Lcom/android/internal/telephony/cat/ComprehensionTlv;
    :cond_5
    const/4 v5, 0x0
...
.method make(Lcom/android/internal/telephony/cat/BerTlv;Lcom/android/internal/telephony/cat/IconLoader;)V
    ...
    const-string v6, "STK make cmdType = "
