...
.field private static final MSG_ID_ICC_RECORDS_LOADED:I = 0x1f
...
# instance fields
.field enRefreshRspFromApForSprdModem:Z
...
.field mIccRefreshResponse:Lcom/android/internal/telephony/uicc/IccRefreshResponse;
...
.method public constructor <init>(Lcom/android/internal/telephony/CommandsInterface;Landroid/content/Context;I)V
    ...
    .line 106
    const-string v0, "ro.config.sprd_refresh_rsp"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/internal/telephony/cat/CatService;->enRefreshRspFromApForSprdModem:Z
    ...
    invoke-static {v0}, Lcom/android/internal/telephony/cat/RilMessageDecoder;->getInstance(I)Lcom/android/internal/telephony/cat/RilMessageDecoder;
...
.method public static getInstance(Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/IccRecords;Landroid/content/Context;I)Lcom/android/internal/telephony/cat/CatService;
    .locals 4
    .parameter "ci"
    .parameter "ir"
    .parameter "context"
    ...
    invoke-direct {v2, p0, p2, p3}, Lcom/android/internal/telephony/cat/CatService;-><init>(Lcom/android/internal/telephony/CommandsInterface;Landroid/content/Context;I)V
...
.method private handleCmdResponse(Lcom/android/internal/telephony/cat/CatResponseMessage;)V
    ...
    .restart local v8       #resp:Lcom/android/internal/telephony/cat/ResponseData;
    :pswitch_7
    const-string v2, "ro.config.setupcall_from_ap"
    ...
    .end local v8           #resp:Lcom/android/internal/telephony/cat/ResponseData;
    .restart local v5       #resp:Lcom/android/internal/telephony/cat/ResponseData;
    const-string v0, "CDMA resMsg set  ResultCode.USER_NOT_ACCEPT"
...
.method private handleSimRefreshLoaded()V
    .locals 6
    ...
    .line 943
    iget-boolean v0, p0, Lcom/android/internal/telephony/cat/CatService;->enRefreshRspFromApForSprdModem:Z
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRefreshResponse:Lcom/android/internal/telephony/uicc/IccRefreshResponse;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 875
    :sswitch_2
    invoke-direct {p0}, Lcom/android/internal/telephony/cat/CatService;->handleSimRefreshLoaded()V
    ...
    iput-object v6, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRefreshResponse:Lcom/android/internal/telephony/uicc/IccRefreshResponse;

    .line 917
    iget-boolean v6, p0, Lcom/android/internal/telephony/cat/CatService;->enRefreshRspFromApForSprdModem:Z
    ...
    const-string v7, "sprd Icc refresh comes, refresh type : "
    ...
    iget v6, v6, Lcom/android/internal/telephony/uicc/IccRefreshResponse;->refreshResult:I
    ...
    .line 919
    iget-object v6, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRecords:Lcom/android/internal/telephony/IccRecords;
    ...
    invoke-virtual {v6, p0, v7, v10}, Lcom/android/internal/telephony/IccRecords;->registerForRecordsLoaded(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 922
    :cond_3
    const/4 v6, 0x2

    iget-object v7, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRefreshResponse:Lcom/android/internal/telephony/uicc/IccRefreshResponse;

    iget v7, v7, Lcom/android/internal/telephony/uicc/IccRefreshResponse;->refreshResult:I
    ...
    invoke-interface {v6, v10}, Lcom/android/internal/telephony/CommandsInterface;->restartRild(Landroid/os/Message;)V
...
.method updateIccAvailability()V
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/cat/CatService;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;
    ...
    invoke-virtual {v1, v5}, Lcom/android/internal/telephony/UiccCard;->getApplicationIndex(I)Lcom/android/internal/telephony/UiccCardApplication;
