...
.field private static final EVENT_CDMA_WAITING_NUMBER_CHANGED:I = 0x96
...
.field protected final mCdmaWaitingNumberChangedRegistrants:Landroid/os/RegistrantList;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallManager;->mCdmaWaitingNumberChangedRegistrants:Landroid/os/RegistrantList;
...
.method private getFirstNonIdleCall(Ljava/util/List;)Lcom/android/internal/telephony/Call;
    ...
    .line 1749
    .local v3, result:Lcom/android/internal/telephony/Call;
    const/4 v1, 0x0

    .line 1750
    .local v1, disconnectingCall:Lcom/android/internal/telephony/Call;
    ...
    .line 1764
    .end local v0           #call:Lcom/android/internal/telephony/Call;
    .end local v1           #disconnectingCall:Lcom/android/internal/telephony/Call;
    :goto_1
    return-object v0

    .line 1755
    .restart local v0       #call:Lcom/android/internal/telephony/Call;
    .restart local v1       #disconnectingCall:Lcom/android/internal/telephony/Call;
    :cond_1
    if-nez v3, :cond_0
...
.method private registerForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-interface {p1, v0, v1, v2}, Lcom/android/internal/telephony/Phone;->registerForCdmaWaitingNumberChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private unregisterForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-interface {p1, v0}, Lcom/android/internal/telephony/Phone;->unregisterForCdmaWaitingNumberChanged(Landroid/os/Handler;)V
...
.method public callModifyConfirm(Lcom/android/internal/telephony/Connection;Lcom/android/internal/telephony/CallModify;)V
    .locals 0
    .parameter "conn"
    .parameter "modifyConfirm"
...
.method public callModifyInitiate(Lcom/android/internal/telephony/Connection;Lcom/android/internal/telephony/CallModify;)V
    .locals 0
    .parameter "conn"
    .parameter "modifyInitiate"
...
.method public dial(Lcom/android/internal/telephony/Phone;Ljava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-interface {p1, p2}, Lcom/android/internal/telephony/Phone;->isMmiCode(Ljava/lang/String;)Z
    ...
    const-string v5, "Switch: no dot switch here, phoneUtil has already done it!"
...
.method public registerForCallModifyRequest(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 0
    .parameter "h"
    .parameter "what"
    .parameter "obj"
...
.method public registerForCdmaWaitingNumberChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .prologue
    .line 1661
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mCdmaWaitingNumberChangedRegistrants:Landroid/os/RegistrantList;
...
.method public setAudioMode()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/CallManager;->setAudioMode(Lcom/android/internal/telephony/Phone;)V
...
.method public setAudioMode(Lcom/android/internal/telephony/Phone;)V
    ...
    .line 439
    .local v3, mState:Lcom/android/internal/telephony/PhoneConstants$State;
    :goto_1
    ...
    .end local v3           #mState:Lcom/android/internal/telephony/PhoneConstants$State;
    :cond_4
    ...
    .line 459
    .restart local v3       #mState:Lcom/android/internal/telephony/PhoneConstants$State;
    :pswitch_1
    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->getFgPhone()Lcom/android/internal/telephony/Phone;
